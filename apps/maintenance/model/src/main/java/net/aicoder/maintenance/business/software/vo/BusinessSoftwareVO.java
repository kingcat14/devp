package net.aicoder.maintenance.business.software.vo;
...
* 应用软件的值对象
*/
@ApiModel(value = "展现应用软件的值对象")
public class BusinessSoftwareVO {
    ...
    private SimpleConfigVO typeCodeVO;
    ...
    public SimpleConfigVO getTypeCodeVO(){
        return typeCodeVO;
    }
    public void setTypeCodeVO(SimpleConfigVO typeCodeVO) {
