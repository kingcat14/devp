 ...
 * @author icode
 */
@ApiModel(value = "修改网络设备使用的DTO")
public class NetworkDeviceEditDto {
	...
	/**名称*/
	@ApiModelProperty(value = "名称", required = false, notes = "[名称]-资产名称")
	private String name;
	...
	/**类型*/
	@ApiModelProperty(value = "类型", required = false, notes = "[类型代码]")
