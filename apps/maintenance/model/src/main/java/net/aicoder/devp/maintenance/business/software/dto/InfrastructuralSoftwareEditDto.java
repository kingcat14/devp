package net.aicoder.devp.maintenance.business.software.dto;
 ...
 * @author icode
 */
@ApiModel(value = "修改基础软件使用的DTO")
public class InfrastructuralSoftwareEditDto {



    /**租户编号*/
	@NotNull(message = "租户编号不能为空")
	@ApiModelProperty(value = "租户编号", required = true, notes = "[租户编号]")
	private Long tid;
	...
	@ApiModelProperty(value = "元素类型", required = true, notes = "[元素类型]-服务器主机ASSET_HOST, 网络设备ASSET_NETWORK, 基础软件ASSET_INFRA_SW, 服务及许可ASSET_SVC_LIC, 业务软件ASSET_BIZ_SW, 其它ASSET_OTHERS")
