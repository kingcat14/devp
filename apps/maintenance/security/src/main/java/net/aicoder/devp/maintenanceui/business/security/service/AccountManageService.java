...
import net.aicoder.devp.maintenanceui.business.security.controller.vo.ResourceTreeNode;
import net.aicoder.devp.maintenanceui.business.security.controller.vo.UpdatePasswordRequest;
import net.aicoder.devp.maintenanceui.business.security.controller.vo.UpdatePasswordResponse;
import net.aicoder.devp.maintenanceui.business.security.domain.*;
import net.aicoder.devp.maintenanceui.business.security.dto.AccountCondition;
import net.aicoder.devp.maintenanceui.business.security.dto.AccountPasswordCondition;
...
public class AccountManageService {
	 ...
	 * @return
	 */
	public List<Resource> findResourceTree(String accountName){
	...
	public List<Resource> findAllResourceTree(){
		...
		for(Resource resource : resourceList){
			treeNodeList.add(new ResourceTreeNode(resource));
		}
