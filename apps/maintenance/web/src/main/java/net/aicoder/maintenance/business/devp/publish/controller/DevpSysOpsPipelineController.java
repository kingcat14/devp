...
import net.aicoder.maintenance.business.devp.publish.service.DevpSysOpsPipelineRibbonService;
import net.aicoder.maintenance.business.devp.publish.valid.DevpSysOpsPipelineValidator;
...
public class DevpSysOpsPipelineController {
	...
	@Autowired
	private DevpSysOpsPipelineRibbonService devpSysOpsPipelineRibbonService;

	@Autowired
	DevpSysOpsPipelineValidator devpSysOpsPipelineValidator;
	...
	public void delete(@PathVariable String idArray){
		...
		for (String id : ids ){
			devpSysOpsPipelineRibbonService.delete(Long.parseLong(id));
		}
	...
	@PutMapping(value="/{id}")
	public DevpSysOpsPipelineVO update(@RequestBody DevpSysOpsPipelineEditDto devpSysOpsPipelineEditDto, @ApiParam(value = "要查询的产品运维流水线id") @PathVariable Long id){

		DevpSysOpsPipelineVO vo = devpSysOpsPipelineRibbonService.merge(id, devpSysOpsPipelineEditDto);
	...
	@GetMapping(value="/{id}")
	public DevpSysOpsPipelineVO get(@ApiParam(value = "要查询的产品运维流水线id") @PathVariable Long id) {

		DevpSysOpsPipelineVO vo = devpSysOpsPipelineRibbonService.find(id);
		return vo;
	}
	...
	public PageContent<DevpSysOpsPipelineVO> list(@RequestBody PageSearchRequest<DevpSysOpsPipelineCondition> pageSearchRequest){
		...
		DevpSysOpsPipelineCondition condition = pageSearchRequest.getSearchCondition();
		if(condition==null){
	...
	private DevpSysOpsPipelineVO initViewProperty( DevpSysOpsPipelineVO vo){
