...
import net.aicoder.devp.maintenance.business.product.product.service.DevpPrdPersonRibbonService;
import net.aicoder.devp.maintenance.business.product.product.valid.DevpPrdPersonValidator;
...
public class DevpPrdPersonController {
	...
	@Autowired
	DevpPrdPersonValidator devpPrdPersonValidator;
	...
	@PutMapping(value="/{id}")
	public DevpPrdPersonVO update(@RequestBody DevpPrdPersonEditDto devpPrdPersonEditDto, @ApiParam(value = "要查询的产品干系人id") @PathVariable Long id){
