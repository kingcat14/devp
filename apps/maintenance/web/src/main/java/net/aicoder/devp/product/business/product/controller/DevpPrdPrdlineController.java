...
import net.aicoder.devp.product.business.product.service.DevpPrdPrdlineRibbonService;
...
public class DevpPrdPrdlineController {
	...
	@PutMapping(value="/{id}")
	public DevpPrdPrdlineVO update(@RequestBody @Valid DevpPrdPrdlineEditDto devpPrdPrdlineEditDto, @ApiParam(value = "要查询的产品线定义id") @PathVariable Long id){
