...
import net.aicoder.devp.product.business.product.service.DevpPrdProductRibbonService;
...
public class DevpPrdProductController {
	...
	@PutMapping(value="/{id}")
	public DevpPrdProductVO update(@RequestBody @Valid DevpPrdProductEditDto devpPrdProductEditDto, @ApiParam(value = "要查询的产品定义id") @PathVariable Long id){
