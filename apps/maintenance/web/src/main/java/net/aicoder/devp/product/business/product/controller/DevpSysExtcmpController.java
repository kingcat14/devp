...
import net.aicoder.devp.product.business.product.service.DevpSysExtcmpRibbonService;
...
public class DevpSysExtcmpController {
	...
	@PutMapping(value="/{id}")
	public DevpSysExtcmpVO update(@RequestBody @Valid DevpSysExtcmpEditDto devpSysExtcmpEditDto, @ApiParam(value = "要查询的产品包含的外部组件id") @PathVariable Long id){
