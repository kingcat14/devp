...
import net.aicoder.devp.maintenance.business.asset.info.dto.AssetCategoryAddDto;
import net.aicoder.devp.maintenance.business.asset.info.dto.AssetCategoryEditDto;
import net.aicoder.devp.maintenance.business.asset.info.service.AssetCategoryService;
import net.aicoder.devp.maintenance.business.asset.info.valid.AssetCategoryValidator;
import net.aicoder.devp.maintenance.business.asset.info.vo.AssetCategoryVO;
...
@RestController
@RequestMapping(value = "/asset/info/assetCategory")
public class AssetCategoryController {
    ...
    public void export(AssetCategoryCondition condition, HttpServletResponse response) throws UnsupportedEncodingException {
        ...
        String fileName = new String("资产大类_".getBytes("UTF-8"), "ISO-8859-1");
