...
import net.aicoder.maintenance.business.maintenance.software.service.SoftwareLicenseRibbonService;
import net.aicoder.maintenance.business.maintenance.software.valid.SoftwareLicenseValidator;
...
public class SoftwareLicenseController {
    ...
    public void export(SoftwareLicenseCondition condition, HttpServletResponse response) throws UnsupportedEncodingException  {
        ...
        String title = new String("服务许可");
        String fileName = new String(("服务许可_"+ DateFormatUtils.ISO_8601_EXTENDED_TIME_FORMAT.format(new Date())).getBytes("UTF-8"), "ISO-8859-1");
