...
@ControllerAdvice class TypedApiResponseBodyHandler implements ResponseBodyAdvice<Object> {

	private static final Logger logger = LoggerFactory.getLogger(TypedApiResponseBodyHandler.class);
