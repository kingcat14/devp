Ext.define('AM.view.product.product.DevpPrdPrdlinePanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'product.product.DevpPrdPrdlinePanel'
    ,title: '产品线定义'
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.product.product.DevpPrdPrdline', modelConfig);
    ...
    ,showAddWindow: function(model, targetComponent) {
        ...
        if(!addWindow||addWindow.isHidden()){
            ...
            addWindow = Ext.create('AM.view.product.product.DevpPrdPrdlineAddWindow',{store:me.getStore()});
    ...
    ,showEditWindow: function(model, targetComponent) {
        ...
        if(!editWindow||editWindow.isHidden()){
            ...
            editWindow = Ext.create('AM.view.product.product.DevpPrdPrdlineEditWindow',{store:me.getStore()});
    ...
    ,showDetailWindow: function(model, targetComponent) {
        ...
        if(!detailWindow||detailWindow.isHidden()){
            ...
            detailWindow = Ext.create('AM.view.product.product.DevpPrdPrdlineDetailWindow',{store:me.getStore()});
    ...
    ,showSearchWindow: function(button, e, options) {
        ...
        if(!searchWindow){
            ...
            searchWindow = Ext.create('AM.view.product.product.DevpPrdPrdlineSearchWindow');
