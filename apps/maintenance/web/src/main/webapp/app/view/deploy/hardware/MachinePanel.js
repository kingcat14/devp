Ext.define('AM.view.deploy.hardware.MachinePanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'deploy.hardware.MachinePanel'
    ,title: '服务器'
    ,requires: [
        'AM.view.deploy.hardware.MachineController'
        ,'AM.view.deploy.hardware.MachineAddWindow'
        ,'AM.view.deploy.hardware.MachineEditWindow'
        ,'AM.view.deploy.hardware.MachineSearchWindow'
        ,'AM.view.deploy.hardware.MachineDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'deploy.hardware.MachineAddWindow',reference:'machineAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.hardware.MachineEditWindow',reference:'machineEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.hardware.MachineSearchWindow',reference:'machineSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'deploy.hardware.MachineDetailWindow',reference:'machineDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.deploy.hardware.Machine', modelConfig);
