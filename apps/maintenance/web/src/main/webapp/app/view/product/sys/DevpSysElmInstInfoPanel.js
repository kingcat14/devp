Ext.define('AM.view.product.sys.DevpSysElmInstInfoPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'product.sys.DevpSysElmInstInfoPanel'
    ,title: '系统元素实例'
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.product.sys.DevpSysElmInstInfo', modelConfig);
    ...
    ,showAddWindow: function(model, targetComponent) {
        ...
        if(!addWindow||addWindow.isHidden()){
            ...
            addWindow = Ext.create('AM.view.product.sys.DevpSysElmInstInfoAddWindow',{store:me.getStore()});
    ...
    ,showEditWindow: function(model, targetComponent) {
        ...
        if(!editWindow||editWindow.isHidden()){
            ...
            editWindow = Ext.create('AM.view.product.sys.DevpSysElmInstInfoEditWindow',{store:me.getStore()});
    ...
    ,showDetailWindow: function(model, targetComponent) {
        ...
        if(!detailWindow||detailWindow.isHidden()){
            ...
            detailWindow = Ext.create('AM.view.product.sys.DevpSysElmInstInfoDetailWindow',{store:me.getStore()});
    ...
    ,showSearchWindow: function(button, e, options) {
        ...
        if(!searchWindow){
            ...
            searchWindow = Ext.create('AM.view.product.sys.DevpSysElmInstInfoSearchWindow');
