Ext.define('AM.view.product.product.DevpPrdLinePrdPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'product.product.DevpPrdLinePrdPanel'
    ,title: '产品所属产品线定义'
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.product.product.DevpPrdLinePrd', modelConfig);

        options.src = button;
        var addWindow = this.showAddWindow(record, button);
        addWindow.setTitle('添加新产品所属产品线定义');
    }
    ,onEditButtonClick: function(button, e, options) {
        ...
        detailWindow.setTitle('修改产品所属产品线定义信息');
    }
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除产品所属产品线定义成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onItemDblClick: function(tablepanel, record, item, index, e, options) {
        ...
        editWindow.setTitle('修改产品所属产品线定义信息');
    }
    ,showAddWindow: function(model, targetComponent) {
        ...
        if(!addWindow||addWindow.isHidden()){
            ...
            addWindow = Ext.create('AM.view.product.product.DevpPrdLinePrdAddWindow',{store:me.getStore()});
    ...
    ,showEditWindow: function(model, targetComponent) {
        ...
        if(!editWindow||editWindow.isHidden()){
            ...
            editWindow = Ext.create('AM.view.product.product.DevpPrdLinePrdEditWindow',{store:me.getStore()});
    ...
    ,showDetailWindow: function(model, targetComponent) {
        ...
        if(!detailWindow||detailWindow.isHidden()){
            ...
            detailWindow = Ext.create('AM.view.product.product.DevpPrdLinePrdDetailWindow',{store:me.getStore()});
    ...
    ,showSearchWindow: function(button, e, options) {
        ...
        if(!searchWindow){
            ...
            searchWindow = Ext.create('AM.view.product.product.DevpPrdLinePrdSearchWindow');
