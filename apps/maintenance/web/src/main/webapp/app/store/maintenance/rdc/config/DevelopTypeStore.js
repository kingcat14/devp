Ext.define('AM.store.maintenance.rdc.config.DevelopTypeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.maintenance.rdc.config.DevelopType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.maintenance.rdc.config.DevelopType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'rdc/config/developType'
                ...
                ,api:{read:"rdc/config/developType/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
