Ext.define('AM.store.maintenance.software.InfrastructuralSoftwareStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.maintenance.software.InfrastructuralSoftware'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.maintenance.software.InfrastructuralSoftware'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"software/infrastructuralSoftware/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
