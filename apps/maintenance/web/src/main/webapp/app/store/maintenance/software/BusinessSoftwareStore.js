Ext.define('AM.store.maintenance.software.BusinessSoftwareStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.maintenance.software.BusinessSoftware'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.maintenance.software.BusinessSoftware'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"software/businessSoftware/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
