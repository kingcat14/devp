Ext.define('AM.store.maintenance.rdc.config.EnvConfigLevelStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.maintenance.rdc.config.EnvConfigLevel'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.maintenance.rdc.config.EnvConfigLevel'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"rdc/config/envConfigLevel/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
