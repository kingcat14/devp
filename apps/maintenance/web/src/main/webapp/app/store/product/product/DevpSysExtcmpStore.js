Ext.define('AM.store.product.product.DevpSysExtcmpStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.product.DevpSysExtcmp'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.product.DevpSysExtcmp'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"product/devpSysExtcmp/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
