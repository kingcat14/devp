Ext.define('AM.store.product.product.DevpPrdPersonStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.product.DevpPrdPerson'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.product.DevpPrdPerson'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"product/devpPrdPerson/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
