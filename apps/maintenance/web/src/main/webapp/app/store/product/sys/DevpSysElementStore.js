Ext.define('AM.store.product.sys.DevpSysElementStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.sys.DevpSysElement'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.sys.DevpSysElement'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"sys/devpSysElement/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
