Ext.define('AM.store.product.sys.DevpSysDgmElementStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.sys.DevpSysDgmElement'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.sys.DevpSysDgmElement'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"sys/devpSysDgmElement/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
