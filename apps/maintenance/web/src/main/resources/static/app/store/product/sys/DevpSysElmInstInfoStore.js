Ext.define('AM.store.product.sys.DevpSysElmInstInfoStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.sys.DevpSysElmInstInfo'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.sys.DevpSysElmInstInfo'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"sys/devpSysElmInstInfo/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
