Ext.define('AM.view.devp.product.DevpSysExtcmpPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'devp.product.DevpSysExtcmpPanel'
    ,title: '产品包含的外部组件'
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.devp.product.DevpSysExtcmp', modelConfig);
    ...
    ,showAddWindow: function(model, targetComponent) {
        ...
        if(!addWindow||addWindow.isHidden()){
            ...
            addWindow = Ext.create('AM.view.devp.product.DevpSysExtcmpAddWindow',{store:me.getStore()});
    ...
    ,showEditWindow: function(model, targetComponent) {
        ...
        if(!editWindow||editWindow.isHidden()){
            ...
            editWindow = Ext.create('AM.view.devp.product.DevpSysExtcmpEditWindow',{store:me.getStore()});
    ...
    ,showDetailWindow: function(model, targetComponent) {
        ...
        if(!detailWindow||detailWindow.isHidden()){
            ...
            detailWindow = Ext.create('AM.view.devp.product.DevpSysExtcmpDetailWindow',{store:me.getStore()});
    ...
    ,showSearchWindow: function(button, e, options) {
        ...
        if(!searchWindow){
            ...
            searchWindow = Ext.create('AM.view.devp.product.DevpSysExtcmpSearchWindow');
