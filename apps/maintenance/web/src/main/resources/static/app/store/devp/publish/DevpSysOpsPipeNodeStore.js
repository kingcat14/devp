Ext.define('AM.store.devp.publish.DevpSysOpsPipeNodeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsPipeNode'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsPipeNode'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'devp/publish/devpsysopspipenode'
                ...
                ,api:{read:"devp/publish/devpsysopspipenode/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
