Ext.define('AM.view.devp.product.DevpPrdLinePrdPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'devp.product.DevpPrdLinePrdPanel'
    ,title: '产品所属产品线定义'
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.devp.product.DevpPrdLinePrd', modelConfig);
    ...
    ,showAddWindow: function(model, targetComponent) {
        ...
        if(!addWindow||addWindow.isHidden()){
            ...
            addWindow = Ext.create('AM.view.devp.product.DevpPrdLinePrdAddWindow',{store:me.getStore()});
    ...
    ,showEditWindow: function(model, targetComponent) {
        ...
        if(!editWindow||editWindow.isHidden()){
            ...
            editWindow = Ext.create('AM.view.devp.product.DevpPrdLinePrdEditWindow',{store:me.getStore()});
    ...
    ,showDetailWindow: function(model, targetComponent) {
        ...
        if(!detailWindow||detailWindow.isHidden()){
            ...
            detailWindow = Ext.create('AM.view.devp.product.DevpPrdLinePrdDetailWindow',{store:me.getStore()});
    ...
    ,showSearchWindow: function(button, e, options) {
        ...
        if(!searchWindow){
            ...
            searchWindow = Ext.create('AM.view.devp.product.DevpPrdLinePrdSearchWindow');
