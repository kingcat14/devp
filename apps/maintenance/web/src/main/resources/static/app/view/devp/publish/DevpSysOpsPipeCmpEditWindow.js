Ext.define('AM.view.devp.publish.DevpSysOpsPipeCmpEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsPipeCmpEditWindow'
    ,requires:[
    ],
    autoScroll: true,
    height: '60%',
    ...
    setModel: function (model) {
        ...
        this.setTitle("修改产品运维流水线对应的组件信息");
