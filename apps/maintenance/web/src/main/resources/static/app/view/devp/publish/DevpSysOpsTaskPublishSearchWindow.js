Ext.define('AM.view.devp.publish.DevpSysOpsTaskPublishSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsTaskPublishSearchWindow'
    ,alias: 'widget.devppublishDevpSysOpsTaskPublishSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
    ...
    ,getCondition: function(){
        ...
        var artifactField = me.down("#artifactField");
        ...
        var condition = {
            ...
            ,template:Ext.isEmpty(templateField.getValue())?null:templateField.getValue()
            ,group:Ext.isEmpty(groupField.getValue())?null:groupField.getValue()
            ,artifact:Ext.isEmpty(artifactField.getValue())?null:artifactField.getValue()
