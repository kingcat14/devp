Ext.define('AM.store.security.AccountRoleRelationStore', {
    extend: 'Ext.data.Store',

    requires: [
        'AM.model.security.AccountRoleRelation'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false,
            model: 'AM.model.security.AccountRoleRelation',
            pageSize: 10,
            proxy: {
                type: 'rest',
                url: 'security/accountRoleRelation',
                reader: {
                    type: 'json',
                    root: 'content'
                },
                actionMethods:{read:'POST'},
                api:{read:"security/accountRoleRelation/list"},
                paramsAsJson:true,
                listeners: {
                    exception: {
