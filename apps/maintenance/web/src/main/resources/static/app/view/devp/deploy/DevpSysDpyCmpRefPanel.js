Ext.define('AM.view.devp.deploy.DevpSysDpyCmpRefPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'devp.deploy.DevpSysDpyCmpRefPanel'
    ,title: '系统元素间关系定义'
    ,requires: [
        'AM.view.devp.deploy.DevpSysDpyCmpRefController'
        ,'AM.view.devp.deploy.DevpSysDpyCmpRefAddWindow'
        ,'AM.view.devp.deploy.DevpSysDpyCmpRefEditWindow'
        ,'AM.view.devp.deploy.DevpSysDpyCmpRefSearchWindow'
        ,'AM.view.devp.deploy.DevpSysDpyCmpRefDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'devp.deploy.DevpSysDpyCmpRefAddWindow',reference:'devpSysDpyCmpRefAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.deploy.DevpSysDpyCmpRefEditWindow',reference:'devpSysDpyCmpRefEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.deploy.DevpSysDpyCmpRefSearchWindow',reference:'devpSysDpyCmpRefSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'devp.deploy.DevpSysDpyCmpRefDetailWindow',reference:'devpSysDpyCmpRefDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.devp.deploy.DevpSysDpyCmpRef', modelConfig);
