Ext.define('AM.store.deploy.deploy.DevpSysDpyResInstStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.deploy.deploy.DevpSysDpyResInst'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.deploy.deploy.DevpSysDpyResInst'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'deploy/devpSysDpyResInst'
                ...
                ,api:{read:"deploy/devpSysDpyResInst/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
