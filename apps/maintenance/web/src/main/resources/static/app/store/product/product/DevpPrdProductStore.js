Ext.define('AM.store.product.product.DevpPrdProductStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.product.DevpPrdProduct'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.product.DevpPrdProduct'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"product/devpPrdProduct/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
