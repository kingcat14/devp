Ext.define('AM.store.deploy.deploy.DevpSysDpyInstSchemeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.deploy.deploy.DevpSysDpyInstScheme'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.deploy.deploy.DevpSysDpyInstScheme'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"deploy/devpSysDpyInstScheme/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
