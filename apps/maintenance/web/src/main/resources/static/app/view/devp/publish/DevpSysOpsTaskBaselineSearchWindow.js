Ext.define('AM.view.devp.publish.DevpSysOpsTaskBaselineSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsTaskBaselineSearchWindow'
    ,alias: 'widget.devppublishDevpSysOpsTaskBaselineSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
    ...
    ,getCondition: function(){
        ...
        var svnFromUrlField = me.down("#svnFromUrlField");
        var svnToUrlField = me.down("#svnToUrlField");
        var operTypeField = me.down("#operTypeField");
        ...
        var condition = {
            ...
            ,svnFromUrl:Ext.isEmpty(svnFromUrlField.getValue())?null:svnFromUrlField.getValue()
            ,svnToUrl:Ext.isEmpty(svnToUrlField.getValue())?null:svnToUrlField.getValue()
            ,operType:Ext.isEmpty(operTypeField.getValue())?null:operTypeField.getValue()
