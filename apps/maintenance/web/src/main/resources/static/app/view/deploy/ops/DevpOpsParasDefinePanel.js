Ext.define('AM.view.deploy.ops.DevpOpsParasDefinePanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'deploy.ops.DevpOpsParasDefinePanel'
    ,title: '运维元素扩充信息'
    ,requires: [
        'AM.view.deploy.ops.DevpOpsParasDefineController'
        ,'AM.view.deploy.ops.DevpOpsParasDefineAddWindow'
        ,'AM.view.deploy.ops.DevpOpsParasDefineEditWindow'
        ,'AM.view.deploy.ops.DevpOpsParasDefineSearchWindow'
        ,'AM.view.deploy.ops.DevpOpsParasDefineDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'deploy.ops.DevpOpsParasDefineAddWindow',reference:'devpOpsParasDefineAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsParasDefineEditWindow',reference:'devpOpsParasDefineEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsParasDefineSearchWindow',reference:'devpOpsParasDefineSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'deploy.ops.DevpOpsParasDefineDetailWindow',reference:'devpOpsParasDefineDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.deploy.ops.DevpOpsParasDefine', modelConfig);
