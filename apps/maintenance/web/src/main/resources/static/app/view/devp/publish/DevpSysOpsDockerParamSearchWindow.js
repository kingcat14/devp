Ext.define('AM.view.devp.publish.DevpSysOpsDockerParamSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsDockerParamSearchWindow'
    ,alias: 'widget.devppublishDevpSysOpsDockerParamSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
