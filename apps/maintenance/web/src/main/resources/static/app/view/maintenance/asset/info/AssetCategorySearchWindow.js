Ext.define('AM.view.maintenance.asset.info.AssetCategorySearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'maintenance.asset.info.AssetCategorySearchWindow'
    ,alias: 'widget.maintenanceasset.infoAssetCategorySearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
