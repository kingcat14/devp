Ext.define('AM.view.security.AccountRoleRelationWindow', {
    ...
    alias: 'widget.securityAccountRoleRelationWindow',
    ...
    title: 'My Window',
    closeAction:'hide',
	accountRoleStore: Ext.create('AM.store.security.AccountRoleRelationStore'),
            ...
            items: [
                {
                    xtype: 'gridpanel',
                    itemId: 'roleGrid',
	                store: Ext.create('AM.store.security.RoleStore', {pageSize:10000}),
                    columnLines: true,
                    columns: [
                        {
                            xtype: 'gridcolumn',
	...
	,onButtonClick: function(button, e, options) {
        ...
        Ext.Array.each(records, function(rec){
            ...
            {
                addCount++;
                accountRoleStore.add(Ext.create('AM.model.security.AccountRoleRelation', {accountId:user.get('id'),roleId:rec.get('id')}));
