Ext.define('AM.store.product.sys.DevpSysDiagramStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.sys.DevpSysDiagram'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.sys.DevpSysDiagram'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"sys/devpSysDiagram/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
