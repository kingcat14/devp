Ext.define('AM.view.devp.ops.DevpOpsIssuePanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'devp.ops.DevpOpsIssuePanel'
    ,title: '问题记录'
    ,requires: [
        'AM.view.devp.ops.DevpOpsIssueController'
        ,'AM.view.devp.ops.DevpOpsIssueAddWindow'
        ,'AM.view.devp.ops.DevpOpsIssueEditWindow'
        ,'AM.view.devp.ops.DevpOpsIssueSearchWindow'
        ,'AM.view.devp.ops.DevpOpsIssueDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'devp.ops.DevpOpsIssueAddWindow',reference:'devpOpsIssueAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.ops.DevpOpsIssueEditWindow',reference:'devpOpsIssueEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.ops.DevpOpsIssueSearchWindow',reference:'devpOpsIssueSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'devp.ops.DevpOpsIssueDetailWindow',reference:'devpOpsIssueDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.devp.ops.DevpOpsIssue', modelConfig);
