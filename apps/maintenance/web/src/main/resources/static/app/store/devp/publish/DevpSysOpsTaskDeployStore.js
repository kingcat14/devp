Ext.define('AM.store.devp.publish.DevpSysOpsTaskDeployStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsTaskDeploy'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsTaskDeploy'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"devp/publish/devpsysopstaskdeploy/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
