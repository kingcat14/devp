Ext.define('AM.store.deploy.deploy.DevpSysDpyResourcesStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.deploy.deploy.DevpSysDpyResources'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.deploy.deploy.DevpSysDpyResources'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'deploy/devpSysDpyResources'
                ...
                ,api:{read:"deploy/devpSysDpyResources/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
