Ext.define('AM.store.maintenance.hardware.MachineStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.maintenance.hardware.Machine'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.maintenance.hardware.Machine'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"hardware/machine/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
