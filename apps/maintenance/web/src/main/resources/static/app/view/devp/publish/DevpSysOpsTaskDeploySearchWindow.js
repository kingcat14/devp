Ext.define('AM.view.devp.publish.DevpSysOpsTaskDeploySearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsTaskDeploySearchWindow'
    ,alias: 'widget.devppublishDevpSysOpsTaskDeploySearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
            ...
            items: [
                {
                    ...
                    ,items:[
                        ...
                        ,{
                            xtype: 'textfield'
                            ,itemId: 'deployPathField'
                            ,fieldLabel: '部署路径'
                        }

                        ,{
                            xtype: 'textfield'
                            ,itemId: 'backupPathField'
                            ,fieldLabel: '备份路径'
                        }
    ...
    ,getCondition: function(){
        ...
        var deployPathField = me.down("#deployPathField");
        var backupPathField = me.down("#backupPathField");
        var preActionField = me.down("#preActionField");
        var deployActionField = me.down("#deployActionField");
        ...
        var condition = {
            ...
            ,deployPath:Ext.isEmpty(deployPathField.getValue())?null:deployPathField.getValue()
            ,backupPath:Ext.isEmpty(backupPathField.getValue())?null:backupPathField.getValue()
            ,preAction:Ext.isEmpty(preActionField.getValue())?null:preActionField.getValue()
            ,deployAction:Ext.isEmpty(deployActionField.getValue())?null:deployActionField.getValue()
