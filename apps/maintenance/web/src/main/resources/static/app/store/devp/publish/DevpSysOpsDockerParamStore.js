Ext.define('AM.store.devp.publish.DevpSysOpsDockerParamStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsDockerParam'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsDockerParam'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'devp/publish/devpsysopsdockerparam'
                ...
                ,api:{read:"devp/publish/devpsysopsdockerparam/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
