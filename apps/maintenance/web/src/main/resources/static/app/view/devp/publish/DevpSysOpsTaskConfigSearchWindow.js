Ext.define('AM.view.devp.publish.DevpSysOpsTaskConfigSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsTaskConfigSearchWindow'
    ,alias: 'widget.devppublishDevpSysOpsTaskConfigSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
            ...
            items: [
                {
                    ...
                    ,items:[
                        ...
                        ,{
                            xtype: 'textfield'
                            ,itemId: 'tplFileNameField'
                            ,fieldLabel: '模板文件名'
                        }

                        ,{
                            xtype: 'textfield'
                            ,itemId: 'targetPathField'
                            ,fieldLabel: '模板路径'
                        }

                        ,{
                            xtype: 'textfield'
                            ,itemId: 'targetFileNameField'
                            ,fieldLabel: '模板文件名'
                        }
    ...
    ,getCondition: function(){
        ...
        var tplPathField = me.down("#tplPathField");
        var tplFileNameField = me.down("#tplFileNameField");
        var targetPathField = me.down("#targetPathField");
        var targetFileNameField = me.down("#targetFileNameField");
        ...
        var condition = {
            ...
            ,tplPath:Ext.isEmpty(tplPathField.getValue())?null:tplPathField.getValue()
            ,tplFileName:Ext.isEmpty(tplFileNameField.getValue())?null:tplFileNameField.getValue()
            ,targetPath:Ext.isEmpty(targetPathField.getValue())?null:targetPathField.getValue()
            ,targetFileName:Ext.isEmpty(targetFileNameField.getValue())?null:targetFileNameField.getValue()
