Ext.define('AM.store.devp.publish.DevpSysOpsPipePlanStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsPipePlan'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsPipePlan'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'devp/publish/devpsysopspipeplan'
                ...
                ,api:{read:"devp/publish/devpsysopspipeplan/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
