Ext.define('AM.store.devp.publish.DevpSysOpsTaskConfigStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsTaskConfig'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsTaskConfig'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"devp/publish/devpsysopstaskconfig/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
