Ext.define('AM.view.devp.publish.DevpSysOpsTaskCompileController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.devp.publish.DevpSysOpsTaskCompileController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.devp.publish.DevpSysOpsTaskCompile', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除编译设置成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "publish/devpSysOpsTaskCompile/export"
            ,method: "POST"
