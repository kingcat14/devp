Ext.define('AM.store.product.product.DevpPrdPrdlineStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.product.DevpPrdPrdline'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.product.DevpPrdPrdline'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"product/devpPrdPrdline/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
