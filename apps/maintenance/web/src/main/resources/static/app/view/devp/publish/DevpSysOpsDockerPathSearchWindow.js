Ext.define('AM.view.devp.publish.DevpSysOpsDockerPathSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsDockerPathSearchWindow'
    ,alias: 'widget.devppublishDevpSysOpsDockerPathSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
            ...
            items: [
                {
                    ...
                    ,items:[
                        ...
                        ,{
                            xtype: 'textfield'
                            ,itemId: 'dockerPathField'
                            ,fieldLabel: '容器挂载路径'
                        }

                        ,{
                            xtype: 'textfield'
                            ,itemId: 'hostPathField'
                            ,fieldLabel: '属主机路径'
                        }
    ...
    ,getCondition: function(){
        ...
        var dockerPathField = me.down("#dockerPathField");
        var hostPathField = me.down("#hostPathField");
        ...
        var condition = {
            ...
            ,dockerPath:Ext.isEmpty(dockerPathField.getValue())?null:dockerPathField.getValue()
            ,hostPath:Ext.isEmpty(hostPathField.getValue())?null:hostPathField.getValue()
