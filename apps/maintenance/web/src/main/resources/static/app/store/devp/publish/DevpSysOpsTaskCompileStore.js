Ext.define('AM.store.devp.publish.DevpSysOpsTaskCompileStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsTaskCompile'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsTaskCompile'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'devp/publish/devpsysopstaskcompile'
                ...
                ,api:{read:"devp/publish/devpsysopstaskcompile/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
