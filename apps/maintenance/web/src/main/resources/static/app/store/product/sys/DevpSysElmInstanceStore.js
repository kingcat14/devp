Ext.define('AM.store.product.sys.DevpSysElmInstanceStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.sys.DevpSysElmInstance'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.sys.DevpSysElmInstance'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"sys/devpSysElmInstance/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
