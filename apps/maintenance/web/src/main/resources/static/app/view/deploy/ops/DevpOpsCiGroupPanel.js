Ext.define('AM.view.deploy.ops.DevpOpsCiGroupPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'deploy.ops.DevpOpsCiGroupPanel'
    ,title: '资产项目分组映射'
    ,requires: [
        'AM.view.deploy.ops.DevpOpsCiGroupController'
        ,'AM.view.deploy.ops.DevpOpsCiGroupAddWindow'
        ,'AM.view.deploy.ops.DevpOpsCiGroupEditWindow'
        ,'AM.view.deploy.ops.DevpOpsCiGroupSearchWindow'
        ,'AM.view.deploy.ops.DevpOpsCiGroupDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'deploy.ops.DevpOpsCiGroupAddWindow',reference:'devpOpsCiGroupAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsCiGroupEditWindow',reference:'devpOpsCiGroupEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsCiGroupSearchWindow',reference:'devpOpsCiGroupSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'deploy.ops.DevpOpsCiGroupDetailWindow',reference:'devpOpsCiGroupDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.deploy.ops.DevpOpsCiGroup', modelConfig);
