Ext.define('AM.store.devp.publish.DevpSysOpsTaskBaselineStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsTaskBaseline'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsTaskBaseline'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"devp/publish/devpsysopstaskbaseline/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
