Ext.define('AM.view.deploy.ops.DevpOpsElementInfoPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'deploy.ops.DevpOpsElementInfoPanel'
    ,title: '系统元素扩充信息'
    ,requires: [
        'AM.view.deploy.ops.DevpOpsElementInfoController'
        ,'AM.view.deploy.ops.DevpOpsElementInfoAddWindow'
        ,'AM.view.deploy.ops.DevpOpsElementInfoEditWindow'
        ,'AM.view.deploy.ops.DevpOpsElementInfoSearchWindow'
        ,'AM.view.deploy.ops.DevpOpsElementInfoDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'deploy.ops.DevpOpsElementInfoAddWindow',reference:'devpOpsElementInfoAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsElementInfoEditWindow',reference:'devpOpsElementInfoEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsElementInfoSearchWindow',reference:'devpOpsElementInfoSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'deploy.ops.DevpOpsElementInfoDetailWindow',reference:'devpOpsElementInfoDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.deploy.ops.DevpOpsElementInfo', modelConfig);
