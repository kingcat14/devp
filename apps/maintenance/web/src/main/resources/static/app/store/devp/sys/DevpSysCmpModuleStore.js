Ext.define('AM.store.devp.sys.DevpSysCmpModuleStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.sys.DevpSysCmpModule'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.sys.DevpSysCmpModule'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"sys/devpSysCmpModule/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
