Ext.define('AM.view.devp.deploy.DevpSysDpyInstSchemePanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'devp.deploy.DevpSysDpyInstSchemePanel'
    ,title: '资源实例所属的部署方案'
    ,requires: [
        'AM.view.devp.deploy.DevpSysDpyInstSchemeController'
        ,'AM.view.devp.deploy.DevpSysDpyInstSchemeAddWindow'
        ,'AM.view.devp.deploy.DevpSysDpyInstSchemeEditWindow'
        ,'AM.view.devp.deploy.DevpSysDpyInstSchemeSearchWindow'
        ,'AM.view.devp.deploy.DevpSysDpyInstSchemeDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'devp.deploy.DevpSysDpyInstSchemeAddWindow',reference:'devpSysDpyInstSchemeAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.deploy.DevpSysDpyInstSchemeEditWindow',reference:'devpSysDpyInstSchemeEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.deploy.DevpSysDpyInstSchemeSearchWindow',reference:'devpSysDpyInstSchemeSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'devp.deploy.DevpSysDpyInstSchemeDetailWindow',reference:'devpSysDpyInstSchemeDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.devp.deploy.DevpSysDpyInstScheme', modelConfig);
