Ext.define('AM.store.maintenance.config.SimpleConfigStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.maintenance.config.SimpleConfig'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.maintenance.config.SimpleConfig'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'config/simpleConfig'
                ...
                ,api:{read:"config/simpleConfig/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
