Ext.define('AM.view.deploy.deploy.DevpSysDpyResInstPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'deploy.deploy.DevpSysDpyResInstPanel'
    ,title: '部署关联资源实例定义'
    ,requires: [
        'AM.view.deploy.deploy.DevpSysDpyResInstController'
        ,'AM.view.deploy.deploy.DevpSysDpyResInstAddWindow'
        ,'AM.view.deploy.deploy.DevpSysDpyResInstEditWindow'
        ,'AM.view.deploy.deploy.DevpSysDpyResInstSearchWindow'
        ,'AM.view.deploy.deploy.DevpSysDpyResInstDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'deploy.deploy.DevpSysDpyResInstAddWindow',reference:'devpSysDpyResInstAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.deploy.DevpSysDpyResInstEditWindow',reference:'devpSysDpyResInstEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.deploy.DevpSysDpyResInstSearchWindow',reference:'devpSysDpyResInstSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'deploy.deploy.DevpSysDpyResInstDetailWindow',reference:'devpSysDpyResInstDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.deploy.deploy.DevpSysDpyResInst', modelConfig);
