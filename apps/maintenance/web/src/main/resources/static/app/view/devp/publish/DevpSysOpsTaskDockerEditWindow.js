Ext.define('AM.view.devp.publish.DevpSysOpsTaskDockerEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsTaskDockerEditWindow'
    ,requires:[
    ],
    autoScroll: true,
    height: '60%',
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存部署容器成功!');
