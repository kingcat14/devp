Ext.define('AM.view.maintenance.software.BusinessSoftwareSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'maintenance.software.BusinessSoftwareSearchWindow'
    ,alias: 'widget.maintenancesoftwareBusinessSoftwareSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
