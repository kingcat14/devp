Ext.define('AM.store.devp.publish.DevpSysOpsTaskPublishStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsTaskPublish'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsTaskPublish'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'devp/publish/devpsysopstaskpublish'
                ...
                ,api:{read:"devp/publish/devpsysopstaskpublish/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
