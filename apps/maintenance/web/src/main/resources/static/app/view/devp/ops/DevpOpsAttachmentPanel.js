Ext.define('AM.view.devp.ops.DevpOpsAttachmentPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'devp.ops.DevpOpsAttachmentPanel'
    ,title: '附件定义'
    ,requires: [
        'AM.view.devp.ops.DevpOpsAttachmentController'
        ,'AM.store.devp.ops.DevpOpsAttachmentStore'
        ,'AM.view.devp.ops.DevpOpsAttachmentAddWindow'
        ,'AM.view.devp.ops.DevpOpsAttachmentEditWindow'
        ,'AM.view.devp.ops.DevpOpsAttachmentSearchWindow'
        ,'AM.view.devp.ops.DevpOpsAttachmentDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        Ext.apply(me, {
            store:Ext.create('AM.store.devp.ops.DevpOpsAttachmentStore', {autoLoad:true})
            ,columnLines: true
            ,columns: [
                {
                    xtype: 'gridcolumn'
        ...
        me.add({xtype:'devp.ops.DevpOpsAttachmentAddWindow',reference:'devpOpsAttachmentAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.ops.DevpOpsAttachmentEditWindow',reference:'devpOpsAttachmentEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.ops.DevpOpsAttachmentSearchWindow',reference:'devpOpsAttachmentSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'devp.ops.DevpOpsAttachmentDetailWindow',reference:'devpOpsAttachmentDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.devp.ops.DevpOpsAttachment', modelConfig);
