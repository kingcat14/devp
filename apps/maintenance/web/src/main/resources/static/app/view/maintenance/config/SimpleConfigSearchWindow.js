Ext.define('AM.view.maintenance.config.SimpleConfigSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'maintenance.config.SimpleConfigSearchWindow'
    ,alias: 'widget.maintenanceconfigSimpleConfigSearchWindow'
    ,autoScroll: true
    ,height: 250
    ,width: 400
    ,layout: {
