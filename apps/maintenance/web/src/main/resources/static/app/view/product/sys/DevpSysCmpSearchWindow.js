Ext.define('AM.view.product.sys.DevpSysCmpSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'product.sys.DevpSysCmpSearchWindow'
    ,alias: 'widget.productsysDevpSysCmpSearchWindow'
    ,autoScroll: true
    ,height: 250
    ,width: 400
    ,layout: {
    ...
    ,getCondition: function(){
        ...
        var installableField = me.down("#installableField");
        var sharedComponentField = me.down("#sharedComponentField");
        var sharedServiceField = me.down("#sharedServiceField");
        ...
        var condition = {
            ...
            ,installable:Ext.isNumber(installableField.getValue())?installableField.getValue():null
            ,sharedComponent:Ext.isNumber(sharedComponentField.getValue())?sharedComponentField.getValue():null
            ,sharedService:Ext.isNumber(sharedServiceField.getValue())?sharedServiceField.getValue():null
