Ext.define('AM.store.devp.publish.DevpSysOpsPipelineStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsPipeline'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsPipeline'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"devp/publish/devpsysopspipeline/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
