Ext.define('AM.view.devp.publish.DevpSysOpsPipeCmpController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.devp.publish.DevpSysOpsPipeCmpController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.devp.publish.DevpSysOpsPipeCmp', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除产品运维流水线对应的组件成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "publish/devpSysOpsPipeCmp/export"
            ,method: "POST"
