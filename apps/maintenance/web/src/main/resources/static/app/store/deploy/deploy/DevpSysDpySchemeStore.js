Ext.define('AM.store.deploy.deploy.DevpSysDpySchemeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.deploy.deploy.DevpSysDpyScheme'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.deploy.deploy.DevpSysDpyScheme'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'deploy/devpSysDpyScheme'
                ...
                ,api:{read:"deploy/devpSysDpyScheme/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
