Ext.define('AM.view.devp.publish.DevpSysOpsTaskBaselineController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.devp.publish.DevpSysOpsTaskBaselineController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.devp.publish.DevpSysOpsTaskBaseline', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除基线设置成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "publish/devpSysOpsTaskBaseline/export"
            ,method: "POST"
