Ext.define('AM.view.devp.sys.DevpSysCmpPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'devp.sys.DevpSysCmpPanel'
    ,title: '系统组件'
    ,requires: [
        'AM.view.devp.sys.DevpSysCmpController'
        ,'AM.view.devp.sys.DevpSysCmpAddWindow'
        ,'AM.view.devp.sys.DevpSysCmpEditWindow'
        ,'AM.view.devp.sys.DevpSysCmpSearchWindow'
        ,'AM.view.devp.sys.DevpSysCmpDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'devp.sys.DevpSysCmpAddWindow',reference:'devpSysCmpAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.sys.DevpSysCmpEditWindow',reference:'devpSysCmpEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.sys.DevpSysCmpSearchWindow',reference:'devpSysCmpSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'devp.sys.DevpSysCmpDetailWindow',reference:'devpSysCmpDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.devp.sys.DevpSysCmp', modelConfig);
