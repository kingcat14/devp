Ext.define('AM.store.deploy.ops.DevpOpsRequirementStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.deploy.ops.DevpOpsRequirement'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.deploy.ops.DevpOpsRequirement'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'ops/devpOpsRequirement'
                ...
                ,api:{read:"ops/devpOpsRequirement/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
