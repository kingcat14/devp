Ext.define('AM.view.deploy.ops.DevpOpsAssetGroupPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'deploy.ops.DevpOpsAssetGroupPanel'
    ,title: '资产分组'
    ,requires: [
        'AM.view.deploy.ops.DevpOpsAssetGroupController'
        ,'AM.view.deploy.ops.DevpOpsAssetGroupAddWindow'
        ,'AM.view.deploy.ops.DevpOpsAssetGroupEditWindow'
        ,'AM.view.deploy.ops.DevpOpsAssetGroupSearchWindow'
        ,'AM.view.deploy.ops.DevpOpsAssetGroupDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'deploy.ops.DevpOpsAssetGroupAddWindow',reference:'devpOpsAssetGroupAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsAssetGroupEditWindow',reference:'devpOpsAssetGroupEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsAssetGroupSearchWindow',reference:'devpOpsAssetGroupSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'deploy.ops.DevpOpsAssetGroupDetailWindow',reference:'devpOpsAssetGroupDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.deploy.ops.DevpOpsAssetGroup', modelConfig);
