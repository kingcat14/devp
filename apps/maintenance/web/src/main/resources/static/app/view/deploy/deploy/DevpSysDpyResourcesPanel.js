Ext.define('AM.view.deploy.deploy.DevpSysDpyResourcesPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'deploy.deploy.DevpSysDpyResourcesPanel'
    ,title: '部署关联资源定义'
    ,requires: [
        'AM.view.deploy.deploy.DevpSysDpyResourcesController'
        ,'AM.view.deploy.deploy.DevpSysDpyResourcesAddWindow'
        ,'AM.view.deploy.deploy.DevpSysDpyResourcesEditWindow'
        ,'AM.view.deploy.deploy.DevpSysDpyResourcesSearchWindow'
        ,'AM.view.deploy.deploy.DevpSysDpyResourcesDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'deploy.deploy.DevpSysDpyResourcesAddWindow',reference:'devpSysDpyResourcesAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.deploy.DevpSysDpyResourcesEditWindow',reference:'devpSysDpyResourcesEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.deploy.DevpSysDpyResourcesSearchWindow',reference:'devpSysDpyResourcesSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'deploy.deploy.DevpSysDpyResourcesDetailWindow',reference:'devpSysDpyResourcesDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.deploy.deploy.DevpSysDpyResources', modelConfig);
