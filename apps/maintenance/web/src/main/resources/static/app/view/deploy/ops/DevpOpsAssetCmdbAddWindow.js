Ext.define('AM.view.deploy.ops.DevpOpsAssetCmdbAddWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'deploy.ops.DevpOpsAssetCmdbAddWindow'
    ,requires:[
    ]
    ,autoScroll: true
    ,height: 350
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存资产定义成功!');
    ...
    setModel: function (model) {
        ...
        this.setTitle("修改资产定义信息");
        if(model.phantom){
            this.setTitle("新增资产定义信息");
        }
