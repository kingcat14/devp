Ext.define('AM.view.maintenance.asset.info.AssetTypePanel', {
    ...
    ,requires: [
        ...
        ,'AM.view.maintenance.asset.info.AssetTypeEditWindow'
        ,'AM.view.maintenance.asset.info.AssetTypeSearchWindow'
        ,'AM.view.maintenance.asset.info.AssetTypeDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'maintenance.asset.info.AssetTypeEditWindow',reference:'assetTypeEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'maintenance.asset.info.AssetTypeSearchWindow',reference:'assetTypeSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'maintenance.asset.info.AssetTypeDetailWindow',reference:'assetTypeDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.maintenance.asset.info.AssetType', modelConfig);
