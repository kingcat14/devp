Ext.define('AM.view.maintenance.asset.info.AssetTypeSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'maintenance.asset.info.AssetTypeSearchWindow'
    ,alias: 'widget.maintenanceasset.infoAssetTypeSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
