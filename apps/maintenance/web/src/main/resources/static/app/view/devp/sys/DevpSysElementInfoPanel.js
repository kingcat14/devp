Ext.define('AM.view.devp.sys.DevpSysElementInfoPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'devp.sys.DevpSysElementInfoPanel'
    ,title: '系统元素扩充信息'
    ,requires: [
        'AM.view.devp.sys.DevpSysElementInfoController'
        ,'AM.view.devp.sys.DevpSysElementInfoAddWindow'
        ,'AM.view.devp.sys.DevpSysElementInfoEditWindow'
        ,'AM.view.devp.sys.DevpSysElementInfoSearchWindow'
        ,'AM.view.devp.sys.DevpSysElementInfoDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'devp.sys.DevpSysElementInfoAddWindow',reference:'devpSysElementInfoAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.sys.DevpSysElementInfoEditWindow',reference:'devpSysElementInfoEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.sys.DevpSysElementInfoSearchWindow',reference:'devpSysElementInfoSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'devp.sys.DevpSysElementInfoDetailWindow',reference:'devpSysElementInfoDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.devp.sys.DevpSysElementInfo', modelConfig);
