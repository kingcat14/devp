Ext.define('AM.view.devp.publish.DevpSysOpsTaskDockerController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.devp.publish.DevpSysOpsTaskDockerController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.devp.publish.DevpSysOpsTaskDocker', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除部署容器成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "publish/devpSysOpsTaskDocker/export"
            ,method: "POST"
