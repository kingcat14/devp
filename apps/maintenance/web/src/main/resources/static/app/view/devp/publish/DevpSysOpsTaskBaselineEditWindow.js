Ext.define('AM.view.devp.publish.DevpSysOpsTaskBaselineEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsTaskBaselineEditWindow'
    ,requires:[
    ],
    autoScroll: true,
    height: '60%',
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存基线设置成功!');
