Ext.define('AM.store.devp.publish.DevpSysOpsDockerPathStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsDockerPath'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsDockerPath'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'devp/publish/devpsysopsdockerpath'
                ...
                ,api:{read:"devp/publish/devpsysopsdockerpath/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
