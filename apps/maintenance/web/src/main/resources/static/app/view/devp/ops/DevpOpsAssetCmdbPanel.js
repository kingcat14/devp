Ext.define('AM.view.devp.ops.DevpOpsAssetCmdbPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'devp.ops.DevpOpsAssetCmdbPanel'
    ,title: '资产定义'
    ,requires: [
        'AM.view.devp.ops.DevpOpsAssetCmdbController'
        ,'AM.view.devp.ops.DevpOpsAssetCmdbAddWindow'
        ,'AM.view.devp.ops.DevpOpsAssetCmdbEditWindow'
        ,'AM.view.devp.ops.DevpOpsAssetCmdbSearchWindow'
        ,'AM.view.devp.ops.DevpOpsAssetCmdbDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'devp.ops.DevpOpsAssetCmdbAddWindow',reference:'devpOpsAssetCmdbAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.ops.DevpOpsAssetCmdbEditWindow',reference:'devpOpsAssetCmdbEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'devp.ops.DevpOpsAssetCmdbSearchWindow',reference:'devpOpsAssetCmdbSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'devp.ops.DevpOpsAssetCmdbDetailWindow',reference:'devpOpsAssetCmdbDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.devp.ops.DevpOpsAssetCmdb', modelConfig);
