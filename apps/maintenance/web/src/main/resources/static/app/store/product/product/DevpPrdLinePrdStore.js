Ext.define('AM.store.product.product.DevpPrdLinePrdStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.product.product.DevpPrdLinePrd'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.product.product.DevpPrdLinePrd'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"product/devpPrdLinePrd/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
