Ext.define('AM.store.devp.publish.DevpSysOpsPipeCmpStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsPipeCmp'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsPipeCmp'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'devp/publish/devpsysopspipecmp'
                ...
                ,api:{read:"devp/publish/devpsysopspipecmp/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
