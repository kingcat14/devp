Ext.define('AM.store.devp.publish.DevpSysOpsTaskHostStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.publish.DevpSysOpsTaskHost'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.publish.DevpSysOpsTaskHost'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'devp/publish/devpsysopstaskhost'
                ...
                ,api:{read:"devp/publish/devpsysopstaskhost/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
