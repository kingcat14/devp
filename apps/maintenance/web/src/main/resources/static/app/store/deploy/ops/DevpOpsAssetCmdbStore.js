Ext.define('AM.store.deploy.ops.DevpOpsAssetCmdbStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.deploy.ops.DevpOpsAssetCmdb'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.deploy.ops.DevpOpsAssetCmdb'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"ops/devpOpsAssetCmdb/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
