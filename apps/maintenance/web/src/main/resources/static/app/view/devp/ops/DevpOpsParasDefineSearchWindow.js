Ext.define('AM.view.devp.ops.DevpOpsParasDefineSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.ops.DevpOpsParasDefineSearchWindow'
    ,alias: 'widget.deployopsDevpOpsParasDefineSearchWindow'
    ,autoScroll: true
    ,height: 250
    ,width: 400
    ,layout: {
