Ext.define('AM.view.product.sys.DevpSysElementEditWindow', {
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存系统元素成功!');
                me.down('form').getForm().loadRecord(newRecord);
                me.store.load({
                    callback: function (records, operation, success) {
                        if (success) {
                            Ext.MsgUtil.show('操作成功', '同步系统元素列表成功');
                        }
                    }
                });
            }
    ...
    setModel: function (model) {
        ...
        this.setTitle("修改系统元素信息");
        if(model.phantom){
            this.setTitle("新增系统元素信息");
        }
