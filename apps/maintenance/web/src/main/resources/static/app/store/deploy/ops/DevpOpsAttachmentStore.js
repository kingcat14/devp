Ext.define('AM.store.deploy.ops.DevpOpsAttachmentStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.deploy.ops.DevpOpsAttachment'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.deploy.ops.DevpOpsAttachment'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"ops/devpOpsAttachment/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
