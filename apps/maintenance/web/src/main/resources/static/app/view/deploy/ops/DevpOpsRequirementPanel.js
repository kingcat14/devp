Ext.define('AM.view.deploy.ops.DevpOpsRequirementPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'deploy.ops.DevpOpsRequirementPanel'
    ,title: '需求定义'
    ,requires: [
        'AM.view.deploy.ops.DevpOpsRequirementController'
        ,'AM.view.deploy.ops.DevpOpsRequirementAddWindow'
        ,'AM.view.deploy.ops.DevpOpsRequirementEditWindow'
        ,'AM.view.deploy.ops.DevpOpsRequirementSearchWindow'
        ,'AM.view.deploy.ops.DevpOpsRequirementDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'deploy.ops.DevpOpsRequirementAddWindow',reference:'devpOpsRequirementAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsRequirementEditWindow',reference:'devpOpsRequirementEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.ops.DevpOpsRequirementSearchWindow',reference:'devpOpsRequirementSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'deploy.ops.DevpOpsRequirementDetailWindow',reference:'devpOpsRequirementDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.deploy.ops.DevpOpsRequirement', modelConfig);
