Ext.define('AM.view.deploy.deploy.DevpSysDpySchemePanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'deploy.deploy.DevpSysDpySchemePanel'
    ,title: '产品部署方案'
    ,requires: [
        'AM.view.deploy.deploy.DevpSysDpySchemeController'
        ,'AM.view.deploy.deploy.DevpSysDpySchemeAddWindow'
        ,'AM.view.deploy.deploy.DevpSysDpySchemeEditWindow'
        ,'AM.view.deploy.deploy.DevpSysDpySchemeSearchWindow'
        ,'AM.view.deploy.deploy.DevpSysDpySchemeDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'deploy.deploy.DevpSysDpySchemeAddWindow',reference:'devpSysDpySchemeAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.deploy.DevpSysDpySchemeEditWindow',reference:'devpSysDpySchemeEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'deploy.deploy.DevpSysDpySchemeSearchWindow',reference:'devpSysDpySchemeSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'deploy.deploy.DevpSysDpySchemeDetailWindow',reference:'devpSysDpySchemeDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.deploy.deploy.DevpSysDpyScheme', modelConfig);
