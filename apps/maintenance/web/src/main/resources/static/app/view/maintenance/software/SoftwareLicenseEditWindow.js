Ext.define('AM.view.maintenance.software.SoftwareLicenseEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'maintenance.software.SoftwareLicenseEditWindow'
    ,requires:[
    ],
    autoScroll: true,
    height: '80%',
    ...
    initComponent: function () {
        ...
        softwareLicenseStatusStore.proxy.extraParams={searchCondition:{configType:'MACHINE-STATUS'}};
