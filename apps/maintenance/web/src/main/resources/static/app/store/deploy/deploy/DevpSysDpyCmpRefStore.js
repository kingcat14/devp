Ext.define('AM.store.deploy.deploy.DevpSysDpyCmpRefStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.deploy.deploy.DevpSysDpyCmpRef'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.deploy.deploy.DevpSysDpyCmpRef'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'deploy/devpSysDpyCmpRef'
                ...
                ,api:{read:"deploy/devpSysDpyCmpRef/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
