Ext.define('AM.view.maintenance.software.InfrastructuralSoftwareAddWindow', {
    ...
    ,initComponent: function () {
        ...
        infrastructuralSoftwareStatusStore.proxy.extraParams={searchCondition:{configType:'MACHINE-STATUS'}};
