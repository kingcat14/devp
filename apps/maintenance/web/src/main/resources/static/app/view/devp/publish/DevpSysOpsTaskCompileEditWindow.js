Ext.define('AM.view.devp.publish.DevpSysOpsTaskCompileEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsTaskCompileEditWindow'
    ,requires:[
    ],
    autoScroll: true,
    height: '60%',
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存编译设置成功!');
