Ext.define('AM.view.devp.publish.DevpSysOpsPipeNodeEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'devp.publish.DevpSysOpsPipeNodeEditWindow'
    ,requires:[
    ],
    autoScroll: true,
    height: '60%',
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存流水线执行节点成功!');
