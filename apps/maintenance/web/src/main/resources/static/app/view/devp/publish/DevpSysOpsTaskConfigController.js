Ext.define('AM.view.devp.publish.DevpSysOpsTaskConfigController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.devp.publish.DevpSysOpsTaskConfigController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.devp.publish.DevpSysOpsTaskConfig', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除配置文件设置成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "publish/devpSysOpsTaskConfig/export"
            ,method: "POST"
