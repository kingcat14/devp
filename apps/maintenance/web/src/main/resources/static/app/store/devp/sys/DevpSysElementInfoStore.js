Ext.define('AM.store.devp.sys.DevpSysElementInfoStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.devp.sys.DevpSysElementInfo'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.devp.sys.DevpSysElementInfo'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"sys/devpSysElementInfo/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
