Ext.define('AM.store.maintenance.hardware.NetworkDeviceStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.maintenance.hardware.NetworkDevice'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.maintenance.hardware.NetworkDevice'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
