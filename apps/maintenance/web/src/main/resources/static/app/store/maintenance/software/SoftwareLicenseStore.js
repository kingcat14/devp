Ext.define('AM.store.maintenance.software.SoftwareLicenseStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.maintenance.software.SoftwareLicense'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.maintenance.software.SoftwareLicense'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"software/softwareLicense/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
