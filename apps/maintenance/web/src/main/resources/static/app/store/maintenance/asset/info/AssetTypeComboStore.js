Ext.define('AM.store.maintenance.asset.info.AssetTypeComboStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.maintenance.asset.info.AssetType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.maintenance.asset.info.AssetType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"asset/info/assetType/tree"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
