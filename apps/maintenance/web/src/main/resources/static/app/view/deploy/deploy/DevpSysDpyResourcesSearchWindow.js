Ext.define('AM.view.deploy.deploy.DevpSysDpyResourcesSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'deploy.deploy.DevpSysDpyResourcesSearchWindow'
    ,alias: 'widget.deploydeployDevpSysDpyResourcesSearchWindow'
    ,autoScroll: true
    ,height: 250
    ,width: 400
    ,layout: {
