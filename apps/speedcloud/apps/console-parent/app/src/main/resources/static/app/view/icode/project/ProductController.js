Ext.define('AM.view.icode.project.ProductController', {
	extend: 'Ext.app.ViewController'
	,requires: [

	]
	,alias: 'controller.icode.project.ProductController'

    ,onAddButtonClick: function() {

        var modelConfig = {}
        var record = Ext.create('AM.model.icode.project.Product', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    ,callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.notification('操作成功','删除产品成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onSimpleSearchButtonClick: function(button, e, options) {
        ...
        var productNameField = me.lookupReference("productNameField");
        searchWindow.down('#productNameField').setValue(productNameField.getValue());

        var productCodeField = me.lookupReference("productCodeField");
        searchWindow.down('#productCodeField').setValue(productCodeField.getValue());
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true 
            ,url: "icode/project/product/export"
            ,method: "POST"
