Ext.define('AM.view.speedcloud.deployscheme.ResourceSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.deployscheme.ResourceSearchWindow'
    ,alias: 'widget.speedclouddeployschemeResourceSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
