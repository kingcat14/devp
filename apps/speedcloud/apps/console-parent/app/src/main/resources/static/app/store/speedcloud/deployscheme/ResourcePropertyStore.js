Ext.define('AM.store.speedcloud.deployscheme.ResourcePropertyStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.deployscheme.ResourcePropertyStore'
    ,requires: [
        'AM.model.speedcloud.deployscheme.ResourceProperty'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deployscheme.ResourceProperty'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deployscheme/resourceproperty'
                ...
                ,api:{read:"speedcloud/deployscheme/resourceproperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
