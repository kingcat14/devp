Ext.define('AM.view.speedcloud.env.EnvMachineController', {
	extend: 'Ext.app.ViewController'
	,requires: [

	]
	,alias: 'controller.speedcloud.env.EnvMachineController'

    ,onAddButtonClick: function() {

        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.env.EnvMachine', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    ,callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.notification('操作成功','删除环境设备关联成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true 
            ,url: "speedcloud/env/envmachine/export"
            ,method: "POST"
