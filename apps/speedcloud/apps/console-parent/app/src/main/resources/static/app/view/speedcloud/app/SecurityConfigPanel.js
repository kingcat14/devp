Ext.define('AM.view.speedcloud.app.SecurityConfigPanel', {
    ...
    , requires: [
        ...
        ,'AM.store.speedcloud.app.SecurityConfigStore'
        ,'AM.view.speedcloud.app.SecurityConfigAddWindow'
        ,'AM.view.speedcloud.app.SecurityConfigEditWindow'
        ,'AM.view.speedcloud.app.SecurityConfigSearchWindow'
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'speedcloud.app.SecurityConfigEditWindow',reference:'mainEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'speedcloud.app.SecurityConfigSearchWindow',reference:'mainSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'speedcloud.app.SecurityConfigDetailWindow',reference:'mainDetailWindow'})
