Ext.define('AM.view.speedcloud.pipeline.exec.PipelineExecNodeParamSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.exec.PipelineExecNodeParamSearchWindow'
    ,alias: 'widget.speedcloudpipeline.execPipelineExecNodeParamSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
            ...
            items: [
                {
                    ...
                    ,items:[
                        ,{
                            xtype: 'combobox'
                            ,store: Ext.create("AM.store.speedcloud.pipeline.exec.PipelineExecNodeStore")
                            ,typeAhead:false
                            ,editable:false
                            ,displayField:'name'
                            ,valueField:'id'
