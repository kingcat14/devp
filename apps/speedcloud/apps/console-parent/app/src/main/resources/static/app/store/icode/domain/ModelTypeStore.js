Ext.define('AM.store.icode.domain.ModelTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.domain.ModelTypeStore'
    ,requires: [
        'AM.model.icode.domain.ModelType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.domain.ModelType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'icode/domain/modeltype'
                ...
                ,api:{read:"icode/domain/modeltype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
