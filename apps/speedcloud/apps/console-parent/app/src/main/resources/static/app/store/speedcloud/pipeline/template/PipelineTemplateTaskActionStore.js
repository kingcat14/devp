Ext.define('AM.store.speedcloud.pipeline.template.PipelineTemplateTaskActionStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.pipeline.template.PipelineTemplateTaskActionStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.template.PipelineTemplateTaskAction'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/template/pipelinetemplatetaskaction'
                ...
                ,api:{read:"speedcloud/pipeline/template/pipelinetemplatetaskaction/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
