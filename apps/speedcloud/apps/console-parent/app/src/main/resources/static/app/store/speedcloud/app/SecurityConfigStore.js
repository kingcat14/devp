Ext.define('AM.store.speedcloud.app.SecurityConfigStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.app.SecurityConfigStore'
    ,requires: [
        'AM.model.speedcloud.app.SecurityConfig'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.app.SecurityConfig'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/app/securityconfig/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
