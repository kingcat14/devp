Ext.define('AM.store.icode.domain.EntityActionParameterStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.domain.EntityActionParameterStore'
    , requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.domain.EntityActionParameter'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'icode/domain/entityactionparameter'
                ...
                ,api:{read:"icode/domain/entityactionparameter/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
