Ext.define('AM.store.icode.project.ProductStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.project.ProductStore'
    ,requires: [
        'AM.model.icode.project.Product'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.project.Product'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"icode/project/product/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
