Ext.define('AM.view.speedcloud.pipeline.PipelineStageController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.pipeline.PipelineStageController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.pipeline.PipelineStage', modelConfig);
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "pipeline/pipelineStage/export"
            ,method: "POST"
