Ext.define('AM.store.speedcloud.config.ConfigDevelopLanguageStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.config.ConfigDevelopLanguage'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.config.ConfigDevelopLanguage'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/config/configdeveloplanguage'
                ...
                ,api:{read:"speedcloud/config/configdeveloplanguage/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
