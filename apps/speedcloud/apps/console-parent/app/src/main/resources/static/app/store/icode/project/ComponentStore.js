Ext.define('AM.store.icode.project.ComponentStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.project.ComponentStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.project.Component'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'icode/project/component'
                ...
                ,api:{read:"icode/project/component/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
