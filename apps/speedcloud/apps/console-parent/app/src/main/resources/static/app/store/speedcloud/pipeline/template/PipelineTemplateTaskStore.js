Ext.define('AM.store.speedcloud.pipeline.template.PipelineTemplateTaskStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.pipeline.template.PipelineTemplateTaskStore'
    ,requires: [
        'AM.model.speedcloud.pipeline.template.PipelineTemplateTask'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.template.PipelineTemplateTask'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/template/pipelinetemplatetask/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
