Ext.define('AM.store.speedcloud.app.CodeRepositoryStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.app.CodeRepositoryStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.app.CodeRepository'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/app/coderepository/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
