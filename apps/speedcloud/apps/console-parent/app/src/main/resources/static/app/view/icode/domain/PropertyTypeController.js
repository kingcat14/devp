Ext.define('AM.view.icode.domain.PropertyTypeController', {
	extend: 'Ext.app.ViewController'
	,requires: [

	]
	,alias: 'controller.icode.domain.PropertyTypeController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.icode.domain.PropertyType', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    ,callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.notification('操作成功','删除属性类型成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true 
            ,url: "icode/domain/propertytype/export"
            ,method: "POST"
