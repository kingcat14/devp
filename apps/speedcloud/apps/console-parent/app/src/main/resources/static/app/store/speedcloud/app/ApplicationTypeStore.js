Ext.define('AM.store.speedcloud.app.ApplicationTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.app.ApplicationTypeStore'
    ,requires: [
        'AM.model.speedcloud.app.ApplicationType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.app.ApplicationType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/app/applicationtype'
                ...
                ,api:{read:"speedcloud/app/applicationtype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
