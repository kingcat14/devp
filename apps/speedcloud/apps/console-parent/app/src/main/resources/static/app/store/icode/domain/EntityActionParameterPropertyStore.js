Ext.define('AM.store.icode.domain.EntityActionParameterPropertyStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.domain.EntityActionParameterPropertyStore'
    ,requires: [
        'AM.model.icode.domain.EntityActionParameterProperty'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.domain.EntityActionParameterProperty'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'icode/domain/entityactionparameterproperty'
                ...
                ,api:{read:"icode/domain/entityactionparameterproperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
