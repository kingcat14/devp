Ext.define('AM.store.speedcloud.pipeline.task.PipelineTaskActionTypePropertyStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.task.PipelineTaskActionTypeProperty'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.task.PipelineTaskActionTypeProperty'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/task/pipelinetaskactiontypeproperty'
                ...
                ,api:{read:"speedcloud/pipeline/task/pipelinetaskactiontypeproperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
