Ext.define('AM.store.speedcloud.env.MachineStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.env.MachineStore'
    ,requires: [
        'AM.model.speedcloud.env.Machine'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.env.Machine'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/env/machine'
                ...
                ,api:{read:"speedcloud/env/machine/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
