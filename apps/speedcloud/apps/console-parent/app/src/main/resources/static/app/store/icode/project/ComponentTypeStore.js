Ext.define('AM.store.icode.project.ComponentTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.project.ComponentTypeStore'
    ,requires: [
        'AM.model.icode.project.ComponentType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.project.ComponentType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'icode/project/componenttype'
                ...
                ,api:{read:"icode/project/componenttype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
