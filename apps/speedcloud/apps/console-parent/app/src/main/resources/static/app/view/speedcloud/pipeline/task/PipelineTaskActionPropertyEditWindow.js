Ext.define('AM.view.speedcloud.pipeline.task.PipelineTaskActionPropertyEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.task.PipelineTaskActionPropertyEditWindow'
    ,requires:[
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存操作属性成功!');
