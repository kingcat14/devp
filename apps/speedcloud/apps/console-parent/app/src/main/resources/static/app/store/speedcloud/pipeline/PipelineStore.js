Ext.define('AM.store.speedcloud.pipeline.PipelineStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.Pipeline'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.Pipeline'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/pipeline'
                ...
                ,api:{read:"speedcloud/pipeline/pipeline/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
