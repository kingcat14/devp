Ext.define('AM.store.speedcloud.pipeline.jenkins.JenkinsAdapterStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.pipeline.jenkins.JenkinsAdapterStore'
    ,requires: [
        'AM.model.speedcloud.pipeline.jenkins.JenkinsAdapter'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.jenkins.JenkinsAdapter'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/jenkins/jenkinsadapter/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
