Ext.define('AM.store.speedcloud.project.ProjectSetStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.project.ProjectSet'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.project.ProjectSet'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/project/projectset'
                ...
                ,api:{read:"speedcloud/project/projectset/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
