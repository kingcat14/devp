Ext.define('AM.view.speedcloud.env.AppEnvConfigController', {
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.env.AppEnvConfig', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    ,callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.notification('操作成功','删除产品环境成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onSimpleSearchButtonClick: function(button, e, options) {
        ...
        var mainGridPanel = me.lookupReference('mainGridPanel');
        mainGridPanel.getStore().proxy.extraParams={searchCondition:{project:projectField.getValue()}};
