Ext.define('AM.store.speedcloud.config.ConfigDevelopLanguageVersionStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.config.ConfigDevelopLanguageVersion'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.config.ConfigDevelopLanguageVersion'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/config/configdeveloplanguageversion/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
