Ext.define('AM.store.icode.project.ComponentDomainRelationStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.project.ComponentDomainRelationStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.project.ComponentDomainRelation'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"icode/project/componentdomainrelation/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
