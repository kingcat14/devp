Ext.define('AM.view.icode.project.ComponentController', {
	extend: 'Ext.app.ViewController'
	,requires: [

	]
	,alias: 'controller.icode.project.ComponentController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.icode.project.Component', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    ,callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.notification('操作成功','删除组件成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true 
            ,url: "icode/project/component/export"
            ,method: "POST"
