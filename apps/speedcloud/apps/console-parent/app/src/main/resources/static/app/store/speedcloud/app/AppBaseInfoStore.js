Ext.define('AM.store.speedcloud.app.AppBaseInfoStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.app.AppBaseInfoStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.app.AppBaseInfo'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/app/appbaseinfo'
                ...
                ,api:{read:"speedcloud/app/appbaseinfo/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
