Ext.define('AM.view.speedcloud.pipeline.task.PipelineTaskActionTypePropertyAddWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.task.PipelineTaskActionTypePropertyAddWindow'
    ,requires:[
