Ext.define('AM.store.speedcloud.config.CodeRepositoryTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.config.CodeRepositoryTypeStore'
    ,requires: [
        'AM.model.speedcloud.config.CodeRepositoryType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.config.CodeRepositoryType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/config/coderepositorytype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
