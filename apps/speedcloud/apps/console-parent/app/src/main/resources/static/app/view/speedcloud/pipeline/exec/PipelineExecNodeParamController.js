Ext.define('AM.view.speedcloud.pipeline.exec.PipelineExecNodeParamController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.pipeline.exec.PipelineExecNodeParamController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.pipeline.exec.PipelineExecNodeParam', modelConfig);
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "pipeline/exec/pipelineExecNodeParam/export"
            ,method: "POST"
