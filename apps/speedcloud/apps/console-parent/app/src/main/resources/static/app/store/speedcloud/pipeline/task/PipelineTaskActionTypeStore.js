Ext.define('AM.store.speedcloud.pipeline.task.PipelineTaskActionTypeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.task.PipelineTaskActionType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.task.PipelineTaskActionType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/task/pipelinetaskactiontype'
                ...
                ,api:{read:"speedcloud/pipeline/task/pipelinetaskactiontype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
