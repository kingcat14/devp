Ext.define('AM.store.speedcloud.pipeline.jenkins.JobMappingStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.pipeline.jenkins.JobMappingStore'
    ,requires: [
        'AM.model.speedcloud.pipeline.jenkins.JobMapping'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.jenkins.JobMapping'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/jenkins/jobmapping/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
