Ext.define('AM.store.icode.tplfile.TplSetStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.tplfile.TplSetStore'
    ,requires: [
        'AM.model.icode.tplfile.TplSet'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.tplfile.TplSet'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'icode/tplfile/tplset'
                ...
                ,api:{read:"icode/tplfile/tplset/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
