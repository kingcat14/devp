Ext.define('AM.store.icode.tplfile.TplCodeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.tplfile.TplCodeStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.tplfile.TplCode'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"icode/tplfile/tplcode/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
