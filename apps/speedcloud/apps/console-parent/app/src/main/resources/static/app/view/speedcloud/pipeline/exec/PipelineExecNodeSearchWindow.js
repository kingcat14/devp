Ext.define('AM.view.speedcloud.pipeline.exec.PipelineExecNodeSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.exec.PipelineExecNodeSearchWindow'
    ,alias: 'widget.speedcloudpipeline.execPipelineExecNodeSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
