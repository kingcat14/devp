Ext.define('AM.view.speedcloud.pipeline.jenkins.JobMappingController', {
	extend: 'Ext.app.ViewController'
	,requires: [

	]
	,alias: 'controller.speedcloud.pipeline.jenkins.JobMappingController'

    ,onAddButtonClick: function() {

        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.pipeline.jenkins.JobMapping', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    ,callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.notification('操作成功','删除任务映射成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true 
            ,url: "speedcloud/pipeline/jenkins/jobmapping/export"
            ,method: "POST"
