Ext.define('AM.store.speedcloud.deployscheme.ResourceCategoryStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.deployscheme.ResourceCategoryStore'
    ,requires: [
        'AM.model.speedcloud.deployscheme.ResourceCategory'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deployscheme.ResourceCategory'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deployscheme/resourcecategory'
                ...
                ,api:{read:"speedcloud/deployscheme/resourcecategory/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
