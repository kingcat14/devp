Ext.define('AM.store.speedcloud.deployscheme.ResourceTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.deployscheme.ResourceTypeStore'
    ,requires: [
        'AM.model.speedcloud.deployscheme.ResourceType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deployscheme.ResourceType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deployscheme/resourcetype'
                ...
                ,api:{read:"speedcloud/deployscheme/resourcetype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
