Ext.define('AM.store.icode.tplfile.TplFileTreeStore', {
    extend: 'Ext.data.TreeStore'
    , alias: 'store.icode.tplfile.TplFileTreeStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            ,proxy: {
                type: 'rest'
                ,url: 'tplfile/tplFileTree'
                //,actionMethods:{read:'POST'}
                ,api:{read:"tplfile/tplFileTree"}
                ,listeners: {
                    exception: {
    ...
    ,beforeload :function(store, operation, eOpts ){
		...
		console.log("type:"+operation.node.get('type'));
		operation.setParams({type:operation.node.get('type')})
