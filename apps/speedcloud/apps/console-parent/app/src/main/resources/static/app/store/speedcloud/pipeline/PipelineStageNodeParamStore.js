Ext.define('AM.store.speedcloud.pipeline.PipelineStageNodeParamStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.PipelineStageNodeParam'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.PipelineStageNodeParam'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/pipelinestagenodeparam/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
