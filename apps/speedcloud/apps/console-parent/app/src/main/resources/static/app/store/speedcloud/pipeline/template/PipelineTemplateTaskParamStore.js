Ext.define('AM.store.speedcloud.pipeline.template.PipelineTemplateTaskParamStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.pipeline.template.PipelineTemplateTaskParamStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.template.PipelineTemplateTaskParam'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/template/pipelinetemplatetaskparam'
                ...
                ,api:{read:"speedcloud/pipeline/template/pipelinetemplatetaskparam/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
