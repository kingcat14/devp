Ext.define('AM.view.speedcloud.deployscheme.SchemeInstantiationEditController', {
	...
	,alias: 'controller.speedcloud.deployscheme.SchemeInstantiationEditController'
    ,initPanel:function(){
	    var me = this;
        ...
        if(!record.get('relationId')){
            ...
            var relation = AM.model.speedcloud.deployscheme.ResourceRelation.load(relationId, {
            	success:function(){
                    ...
                    relationEditPanel.getViewModel().set('phantom', relation.phantom);
                    relationEditPanel.getViewModel().set('record', relation);

                    relationEditPanel.getForm().loadRecord(relation);
                }
			})
