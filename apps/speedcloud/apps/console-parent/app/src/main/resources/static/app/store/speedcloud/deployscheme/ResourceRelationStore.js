Ext.define('AM.store.speedcloud.deployscheme.ResourceRelationStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.deployscheme.ResourceRelationStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deployscheme.ResourceRelation'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deployscheme/resourcerelation'
                ...
                ,api:{read:"speedcloud/deployscheme/resourcerelation/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
