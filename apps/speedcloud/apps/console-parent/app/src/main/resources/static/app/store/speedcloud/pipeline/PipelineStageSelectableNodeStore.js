Ext.define('AM.store.speedcloud.pipeline.PipelineStageSelectableNodeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.PipelineStageSelectableNode'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.PipelineStageSelectableNode'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/pipelinestageselectablenode'
                ...
                ,api:{read:"speedcloud/pipeline/pipelinestageselectablenode/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
