Ext.define('AM.store.speedcloud.config.DevelopTypeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.config.DevelopType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.config.DevelopType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/config/developtype'
                ...
                ,api:{read:"speedcloud/config/developtype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
