Ext.define('AM.store.speedcloud.config.PipelineTaskTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.config.PipelineTaskTypeStore'
    ,requires: [
        'AM.model.speedcloud.config.PipelineTaskType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.config.PipelineTaskType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/config/pipelinetasktype'
                ...
                ,api:{read:"speedcloud/config/pipelinetasktype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
