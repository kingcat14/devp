Ext.define('AM.store.speedcloud.deployscheme.ResourceStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.deployscheme.ResourceStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deployscheme.Resource'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deployscheme/resource'
                ...
                ,api:{read:"speedcloud/deployscheme/resource/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
