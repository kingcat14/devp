Ext.define('AM.view.console.jointjs.JointDataController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.console.jointjs.JointDataController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.console.jointjs.JointData', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除图形数据成功!');
                    }
                });
            }
            ,scope:me.getStore()
