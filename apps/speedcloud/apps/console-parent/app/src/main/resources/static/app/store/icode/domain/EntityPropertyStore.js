Ext.define('AM.store.icode.domain.EntityPropertyStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.domain.EntityPropertyStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.domain.EntityProperty'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"icode/domain/entityproperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
