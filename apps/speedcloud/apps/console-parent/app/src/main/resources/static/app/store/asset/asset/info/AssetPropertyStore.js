Ext.define('AM.store.asset.asset.info.AssetPropertyStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.asset.asset.info.AssetPropertyStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.asset.asset.info.AssetProperty'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'asset/asset/info/assetproperty'
                ...
                ,api:{read:"asset/asset/info/assetproperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
