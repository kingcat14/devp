Ext.define('AM.view.speedcloud.pipeline.template.PipelineTemplateTaskActionEditPanel', {
    extend: 'Ext.panel.Panel'
    ,xtype: 'speedcloud.pipeline.template.PipelineTemplateTaskActionEditPanel'
    ,requires:[
