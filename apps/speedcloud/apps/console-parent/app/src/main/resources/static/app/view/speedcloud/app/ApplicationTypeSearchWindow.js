Ext.define('AM.view.speedcloud.app.ApplicationTypeSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.app.ApplicationTypeSearchWindow'
    ,alias: 'widget.speedcloudappApplicationTypeSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
