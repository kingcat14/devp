Ext.define('AM.view.speedcloud.config.DevelopTypeController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.config.DevelopTypeController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.config.DevelopType', modelConfig);
