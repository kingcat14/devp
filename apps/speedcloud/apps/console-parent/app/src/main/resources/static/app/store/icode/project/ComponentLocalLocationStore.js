Ext.define('AM.store.icode.project.ComponentLocalLocationStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.project.ComponentLocalLocationStore'
    ,requires: [
        'AM.model.icode.project.ComponentLocalLocation'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.project.ComponentLocalLocation'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"icode/project/componentlocallocation/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
