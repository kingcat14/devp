Ext.define('AM.store.speedcloud.pipeline.exec.PipelineExecNodeParamStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.exec.PipelineExecNodeParam'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.exec.PipelineExecNodeParam'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/exec/pipelineexecnodeparam'
                ...
                ,api:{read:"speedcloud/pipeline/exec/pipelineexecnodeparam/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
