Ext.define('AM.store.icode.domain.EntityActionStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.icode.domain.EntityActionStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode.domain.EntityAction'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'icode/domain/entityaction'
                ...
                ,api:{read:"icode/domain/entityaction/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
