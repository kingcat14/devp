Ext.define('AM.view.speedcloud.config.EnvLevelSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.config.EnvLevelSearchWindow'
    ,alias: 'widget.speedcloudconfigEnvLevelSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
