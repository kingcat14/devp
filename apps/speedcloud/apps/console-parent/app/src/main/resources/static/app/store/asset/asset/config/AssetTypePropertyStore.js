Ext.define('AM.store.asset.asset.config.AssetTypePropertyStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.asset.asset.config.AssetTypePropertyStore'
    ,requires: [
        'AM.model.asset.asset.config.AssetTypeProperty'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.asset.asset.config.AssetTypeProperty'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"asset/asset/config/assettypeproperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
