...
public class CodeBaseInfoController {
	...
	public void delete(@PathVariable String idArray){
		...
		String[] ids = idArray.split(",");
      	for (String id : ids ){
			codeBaseInfoRibbonService.delete(id);
		}
	 ...
	 * @return
	 */
	@ApiOperation(value = "修改", notes = "修改产代码基本信息(修改全部字段,未传入置空)", httpMethod = "PUT")
	@PutMapping(path="/{id}")
	public CodeBaseInfoVO update(@RequestBody @Valid CodeBaseInfoEditDto codeBaseInfoEditDto, @ApiParam(value = "要查询的代码基本信息id") @PathVariable String id){
	 ...
	 * @return
	 */
	@ApiOperation(value = "查询", notes = "根据ID查询代码基本信息", httpMethod = "GET")
	@GetMapping(path="/{id}")
	public CodeBaseInfoVO get(@ApiParam(value = "要查询的代码基本信息id") @PathVariable String id) {
	...
	@PostMapping(path="/list")
  	@SaaSAnnotation(conditionClass = CodeBaseInfoCondition.class)
	public PageContent<CodeBaseInfoVO> list(@RequestBody @Valid PageSearchRequest<CodeBaseInfoCondition> pageSearchRequest){
