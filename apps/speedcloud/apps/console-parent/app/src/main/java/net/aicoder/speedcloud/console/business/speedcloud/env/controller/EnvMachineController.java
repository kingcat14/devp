...
public class EnvMachineController {
	...
	@Autowired
	EnvMachineValidator envMachineValidator;
	...
	@PutMapping(value="/{id}")
	public EnvMachineVO update(@RequestBody EnvMachineEditDto envMachineEditDto, @ApiParam(value = "要查询的环境设备关联id") @PathVariable Long id){
