Ext.define('AM.view.speedcloud.pipeline.exec.PipelineExecInstanceNodeParamController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.pipeline.exec.PipelineExecInstanceNodeParamController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.pipeline.exec.PipelineExecInstanceNodeParam', modelConfig);
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "pipeline/exec/pipelineExecInstanceNodeParam/export"
            ,method: "POST"
