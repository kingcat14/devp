Ext.define('AM.store.speedcloud.deploy.DevpSysDpyResourcesTypeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.deploy.DevpSysDpyResourcesType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deploy.DevpSysDpyResourcesType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deploy/devpsysdpyresourcestype'
                ...
                ,api:{read:"speedcloud/deploy/devpsysdpyresourcestype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
