Ext.define('AM.store.speedcloud.pipeline.PipelineTaskTypeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.PipelineTaskType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.PipelineTaskType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/pipelinetasktype'
                ...
                ,api:{read:"speedcloud/pipeline/pipelinetasktype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
