Ext.define('AM.view.speedcloud.app.CodeRepertoryController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.app.CodeRepertoryController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.app.CodeRepertory', modelConfig);
