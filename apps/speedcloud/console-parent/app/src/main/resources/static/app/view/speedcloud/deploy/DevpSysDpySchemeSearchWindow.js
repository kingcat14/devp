Ext.define('AM.view.speedcloud.deploy.DevpSysDpySchemeSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.deploy.DevpSysDpySchemeSearchWindow'
    ,alias: 'widget.speedclouddeployDevpSysDpySchemeSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
