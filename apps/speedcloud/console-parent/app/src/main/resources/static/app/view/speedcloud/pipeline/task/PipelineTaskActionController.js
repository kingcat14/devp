Ext.define('AM.view.speedcloud.pipeline.task.PipelineTaskActionController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.pipeline.task.PipelineTaskActionController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.pipeline.task.PipelineTaskAction', modelConfig);
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "pipeline/task/pipelineTaskAction/export"
            ,method: "POST"
