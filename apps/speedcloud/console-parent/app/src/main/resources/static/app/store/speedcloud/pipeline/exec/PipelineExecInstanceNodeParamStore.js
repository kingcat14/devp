Ext.define('AM.store.speedcloud.pipeline.exec.PipelineExecInstanceNodeParamStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.exec.PipelineExecInstanceNodeParam'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.exec.PipelineExecInstanceNodeParam'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/exec/pipelineexecinstancenodeparam'
                ...
                ,api:{read:"speedcloud/pipeline/exec/pipelineexecinstancenodeparam/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
