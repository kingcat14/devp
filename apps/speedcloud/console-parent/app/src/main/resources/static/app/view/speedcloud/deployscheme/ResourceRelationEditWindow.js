Ext.define('AM.view.speedcloud.deployscheme.ResourceRelationEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.deployscheme.ResourceRelationEditWindow'
    ,requires:[
