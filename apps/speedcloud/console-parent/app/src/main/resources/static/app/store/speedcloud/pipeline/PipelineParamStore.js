Ext.define('AM.store.speedcloud.pipeline.PipelineParamStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.PipelineParam'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.PipelineParam'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/pipelineparam'
                ...
                ,api:{read:"speedcloud/pipeline/pipelineparam/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
