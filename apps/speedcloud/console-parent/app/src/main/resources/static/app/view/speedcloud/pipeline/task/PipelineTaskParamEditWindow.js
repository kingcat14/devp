Ext.define('AM.view.speedcloud.pipeline.task.PipelineTaskParamEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.task.PipelineTaskParamEditWindow'
    ,requires:[
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存任务参数成功!');
