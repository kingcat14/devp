Ext.define('AM.store.speedcloud.pipeline.exec.PipelineExecInstanceNodeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.exec.PipelineExecInstanceNode'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.exec.PipelineExecInstanceNode'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/exec/pipelineexecinstancenode'
                ...
                ,api:{read:"speedcloud/pipeline/exec/pipelineexecinstancenode/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
