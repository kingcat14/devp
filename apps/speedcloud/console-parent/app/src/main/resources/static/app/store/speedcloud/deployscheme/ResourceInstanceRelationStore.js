Ext.define('AM.store.speedcloud.deployscheme.ResourceInstanceRelationStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.deployscheme.ResourceInstanceRelationStore'
    ,requires: [
        'AM.model.speedcloud.deployscheme.ResourceInstanceRelation'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deployscheme.ResourceInstanceRelation'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/deployscheme/resourceinstancerelation/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
