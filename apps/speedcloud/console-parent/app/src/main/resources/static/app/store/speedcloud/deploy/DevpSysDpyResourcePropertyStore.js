Ext.define('AM.store.speedcloud.deploy.DevpSysDpyResourcePropertyStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.deploy.DevpSysDpyResourceProperty'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deploy.DevpSysDpyResourceProperty'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deploy/devpsysdpyresourceproperty'
                ...
                ,api:{read:"speedcloud/deploy/devpsysdpyresourceproperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
