Ext.define('AM.store.speedcloud.pipeline.exec.PipelineExecInstanceStore', {
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.exec.PipelineExecInstance'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/exec/pipelineexecinstance/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
