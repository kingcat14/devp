Ext.define('AM.view.speedcloud.pipeline.exec.PipelineExecInstanceNodeParamsSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.exec.PipelineExecInstanceNodeParamsSearchWindow'
    ,alias: 'widget.speedcloudpipeline.execPipelineExecInstanceNodeParamsSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
