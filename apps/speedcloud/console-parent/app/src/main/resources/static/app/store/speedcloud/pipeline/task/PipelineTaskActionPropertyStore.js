Ext.define('AM.store.speedcloud.pipeline.task.PipelineTaskActionPropertyStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.task.PipelineTaskActionProperty'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.task.PipelineTaskActionProperty'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/task/pipelinetaskactionproperty'
                ...
                ,api:{read:"speedcloud/pipeline/task/pipelinetaskactionproperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
