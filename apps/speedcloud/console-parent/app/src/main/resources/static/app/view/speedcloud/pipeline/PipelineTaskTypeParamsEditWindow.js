Ext.define('AM.view.speedcloud.pipeline.PipelineTaskTypeParamsEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.PipelineTaskTypeParamsEditWindow'
    ,requires:[
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存任务类型参数定义成功!');
