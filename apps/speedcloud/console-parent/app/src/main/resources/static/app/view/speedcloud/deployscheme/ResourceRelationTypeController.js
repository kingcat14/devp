Ext.define('AM.view.speedcloud.deployscheme.ResourceRelationTypeController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.deployscheme.ResourceRelationTypeController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.deployscheme.ResourceRelationType', modelConfig);
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "deployScheme/resourceRelationType/export"
            ,method: "POST"
