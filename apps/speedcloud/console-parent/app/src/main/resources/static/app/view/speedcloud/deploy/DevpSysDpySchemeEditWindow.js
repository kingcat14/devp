Ext.define('AM.view.speedcloud.deploy.DevpSysDpySchemeEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.deploy.DevpSysDpySchemeEditWindow'
    ,requires:[
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存部署方案成功!');
