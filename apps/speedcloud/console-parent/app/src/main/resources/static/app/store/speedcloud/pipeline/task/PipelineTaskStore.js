Ext.define('AM.store.speedcloud.pipeline.task.PipelineTaskStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.task.PipelineTask'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.task.PipelineTask'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/task/pipelinetask'
                ...
                ,api:{read:"speedcloud/pipeline/task/pipelinetask/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
