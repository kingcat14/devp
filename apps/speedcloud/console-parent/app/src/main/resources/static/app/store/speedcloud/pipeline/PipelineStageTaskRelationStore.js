Ext.define('AM.store.speedcloud.pipeline.PipelineStageTaskRelationStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.PipelineStageTaskRelation'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.PipelineStageTaskRelation'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/pipelinestagetaskrelation/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
