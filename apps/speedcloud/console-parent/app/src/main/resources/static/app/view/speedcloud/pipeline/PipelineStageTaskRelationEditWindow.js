Ext.define('AM.view.speedcloud.pipeline.PipelineStageTaskRelationEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.PipelineStageTaskRelationEditWindow'
    ,requires:[
