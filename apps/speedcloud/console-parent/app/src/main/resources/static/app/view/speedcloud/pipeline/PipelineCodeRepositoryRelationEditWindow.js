Ext.define('AM.view.speedcloud.pipeline.PipelineCodeRepositoryRelationEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.PipelineCodeRepositoryRelationEditWindow'
    ,requires:[
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存流水线代码库关联成功!');
