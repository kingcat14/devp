Ext.define('AM.view.asset.asset.config.AssetCategoryController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.asset.asset.config.AssetCategoryController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.asset.asset.config.AssetCategory', modelConfig);
