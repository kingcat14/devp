Ext.define('AM.view.speedcloud.pipeline.PipelineStageTaskRelationController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.pipeline.PipelineStageTaskRelationController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.pipeline.PipelineStageTaskRelation', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除阶段任务关联成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "pipeline/pipelineStageTaskRelation/export"
            ,method: "POST"
