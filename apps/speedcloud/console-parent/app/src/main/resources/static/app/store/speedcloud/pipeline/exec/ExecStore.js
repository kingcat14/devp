Ext.define('AM.store.speedcloud.pipeline.exec.ExecStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.exec.Exec'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.exec.Exec'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/exec/exec'
                ...
                ,api:{read:"speedcloud/pipeline/exec/exec/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
