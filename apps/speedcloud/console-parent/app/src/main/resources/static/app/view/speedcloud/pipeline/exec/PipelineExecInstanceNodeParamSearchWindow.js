Ext.define('AM.view.speedcloud.pipeline.exec.PipelineExecInstanceNodeParamSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.exec.PipelineExecInstanceNodeParamSearchWindow'
    ,alias: 'widget.speedcloudpipeline.execPipelineExecInstanceNodeParamSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
            ...
            items: [
                {
                    ...
                    ,items:[
                        ,{
                            xtype: 'combobox'
                            ,store: Ext.create("AM.store.speedcloud.pipeline.exec.PipelineExecInstanceNodeStore")
                            ,typeAhead:false
                            ,editable:false
                            ,displayField:'name'
                            ,valueField:'id'
    ...
    ,getCondition: function(){
        ...
        var me = this;
        var nodeField = me.down("#nodeField");
        ...
        var condition = {
            node:Ext.isEmpty(nodeField.getValue())?null:nodeField.getValue()
