Ext.define('AM.view.speedcloud.pipeline.exec.ExecNodeSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.exec.ExecNodeSearchWindow'
    ,alias: 'widget.speedcloudpipeline.execExecNodeSearchWindow'
    ,autoScroll: true
    ,height: '60%'
    ,width: '60%'
    ,layout: {
