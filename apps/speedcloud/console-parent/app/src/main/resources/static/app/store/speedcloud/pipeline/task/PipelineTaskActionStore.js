Ext.define('AM.store.speedcloud.pipeline.task.PipelineTaskActionStore', {
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.task.PipelineTaskAction'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/task/pipelinetaskaction/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
