Ext.define('AM.store.speedcloud.pipeline.PipelineTaskStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.PipelineTask'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.PipelineTask'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/pipelinetask/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
