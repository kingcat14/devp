Ext.define('AM.store.asset.asset.config.AssetTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.asset.asset.config.AssetTypeStore'
    ,requires: [
        'AM.model.asset.asset.config.AssetType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.asset.asset.config.AssetType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'asset/asset/config/assettype'
                ...
                ,api:{read:"asset/asset/config/assettype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
