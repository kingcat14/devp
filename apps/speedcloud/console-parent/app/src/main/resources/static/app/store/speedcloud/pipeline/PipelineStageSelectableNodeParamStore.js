Ext.define('AM.store.speedcloud.pipeline.PipelineStageSelectableNodeParamStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.PipelineStageSelectableNodeParam'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.PipelineStageSelectableNodeParam'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/pipelinestageselectablenodeparam/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
