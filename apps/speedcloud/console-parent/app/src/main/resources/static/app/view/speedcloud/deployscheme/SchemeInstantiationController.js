Ext.define('AM.view.speedcloud.deployscheme.SchemeInstantiationController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.deployscheme.SchemeInstantiationController'
    ...
    ,createPipelineTabOnMainContentPanel:function(record, referenceId){
        ...
        var panel = Ext.create('AM.view.speedcloud.deployscheme.SchemeInstantiationEditPanel',{
            reference:'DeploySchemeInstantiationEditPanel_'+referenceId
            , title:'实例化方案【'+record.get('name')+"】"
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.deployscheme.Scheme', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除部署方案成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onSimpleSearchButtonClick: function(button, e, options) {
        ...
        searchWindow.down('#codeField').setValue(codeField.getValue());
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "deployScheme/scheme/export"
            ,method: "POST"
