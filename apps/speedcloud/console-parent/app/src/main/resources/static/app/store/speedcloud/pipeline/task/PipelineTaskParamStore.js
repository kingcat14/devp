Ext.define('AM.store.speedcloud.pipeline.task.PipelineTaskParamStore', {
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.task.PipelineTaskParam'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/task/pipelinetaskparam/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
