Ext.define('AM.store.speedcloud.deployscheme.ResourceRelationTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.deployscheme.ResourceRelationTypeStore'
    ,requires: [
        'AM.model.speedcloud.deployscheme.ResourceRelationType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deployscheme.ResourceRelationType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deployscheme/resourcerelationtype'
                ...
                ,api:{read:"speedcloud/deployscheme/resourcerelationtype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
