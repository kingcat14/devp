Ext.define('AM.view.speedcloud.deployscheme.SchemeController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.deployscheme.SchemeController'
    ...
    ,createPipelineTabOnMainContentPanel:function(record, referenceId){
        ...
        var panel = Ext.create('AM.view.speedcloud.deployscheme.SchemeEditPanel',{
            reference:'DeploySchemeEditPanel_'+referenceId
