Ext.define('AM.store.speedcloud.deploy.DevpSysDpyResourceRelationTypeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.deploy.DevpSysDpyResourceRelationType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deploy.DevpSysDpyResourceRelationType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deploy/devpsysdpyresourcerelationtype'
                ...
                ,api:{read:"speedcloud/deploy/devpsysdpyresourcerelationtype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
