Ext.define('AM.view.speedcloud.pipeline.exec.PipelineExecNodeController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.pipeline.exec.PipelineExecNodeController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.pipeline.exec.PipelineExecNode', modelConfig);
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "pipeline/exec/pipelineExecNode/export"
            ,method: "POST"
