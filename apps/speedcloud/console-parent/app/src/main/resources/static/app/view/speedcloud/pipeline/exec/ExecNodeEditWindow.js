Ext.define('AM.view.speedcloud.pipeline.exec.ExecNodeEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'speedcloud.pipeline.exec.ExecNodeEditWindow'
    ,requires:[
                    ...
                    items: [
                        {
                            ...
                            ,items:[
                                ...
                                ,{
                                    xtype: 'combobox'
                                    ,store: Ext.create("AM.store.speedcloud.pipeline.exec.ExecStore")
                                    ,typeAhead:false
                                    ,editable:false
                                    ,displayField:'code'
                                    ,valueField:'id'
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存运行实例节点成功!');
    ...
    ,onBeforeShow:function() {
        ...
        this.down('#execField').getStore().reload();
