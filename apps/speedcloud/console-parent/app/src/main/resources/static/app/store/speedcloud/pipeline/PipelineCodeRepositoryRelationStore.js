Ext.define('AM.store.speedcloud.pipeline.PipelineCodeRepositoryRelationStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.PipelineCodeRepositoryRelation'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.PipelineCodeRepositoryRelation'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/pipelinecoderepositoryrelation/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
