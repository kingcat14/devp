Ext.define('AM.store.speedcloud.deploy.DevpSysDpySchemeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.deploy.DevpSysDpyScheme'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deploy.DevpSysDpyScheme'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deploy/devpsysdpyscheme'
                ...
                ,api:{read:"speedcloud/deploy/devpsysdpyscheme/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
