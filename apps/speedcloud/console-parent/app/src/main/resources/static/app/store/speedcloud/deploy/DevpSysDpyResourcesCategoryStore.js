Ext.define('AM.store.speedcloud.deploy.DevpSysDpyResourcesCategoryStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.deploy.DevpSysDpyResourcesCategory'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deploy.DevpSysDpyResourcesCategory'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deploy/devpsysdpyresourcescategory'
                ...
                ,api:{read:"speedcloud/deploy/devpsysdpyresourcescategory/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
