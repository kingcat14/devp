Ext.define('AM.store.speedcloud.app.CodeRepertoryStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.app.CodeRepertory'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.app.CodeRepertory'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/app/coderepertory'
                ...
                ,api:{read:"speedcloud/app/coderepertory/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
