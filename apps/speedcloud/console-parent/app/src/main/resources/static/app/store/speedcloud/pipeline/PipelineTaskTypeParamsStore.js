Ext.define('AM.store.speedcloud.pipeline.PipelineTaskTypeParamsStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.PipelineTaskTypeParams'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.PipelineTaskTypeParams'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/pipelinetasktypeparams'
                ...
                ,api:{read:"speedcloud/pipeline/pipelinetasktypeparams/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
