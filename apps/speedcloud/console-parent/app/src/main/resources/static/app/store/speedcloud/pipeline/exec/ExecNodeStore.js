Ext.define('AM.store.speedcloud.pipeline.exec.ExecNodeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.exec.ExecNode'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.exec.ExecNode'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"speedcloud/pipeline/exec/execnode/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
