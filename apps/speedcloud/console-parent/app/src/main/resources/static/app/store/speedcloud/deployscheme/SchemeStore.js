Ext.define('AM.store.speedcloud.deployscheme.SchemeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.speedcloud.deployscheme.SchemeStore'
    ,requires: [
        'AM.model.speedcloud.deployscheme.Scheme'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.deployscheme.Scheme'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/deployscheme/scheme'
                ...
                ,api:{read:"speedcloud/deployscheme/scheme/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
