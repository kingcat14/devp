Ext.define('AM.store.speedcloud.pipeline.exec.PipelineExecInstanceNodeParamsStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.exec.PipelineExecInstanceNodeParams'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.exec.PipelineExecInstanceNodeParams'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/exec/pipelineexecinstancenodeparams'
                ...
                ,api:{read:"speedcloud/pipeline/exec/pipelineexecinstancenodeparams/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
