Ext.define('AM.store.asset.asset.info.AssetOwnershipStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.asset.asset.info.AssetOwnershipStore'
    ,requires: [
        'AM.model.asset.asset.info.AssetOwnership'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.asset.asset.info.AssetOwnership'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"asset/asset/info/assetownership/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
