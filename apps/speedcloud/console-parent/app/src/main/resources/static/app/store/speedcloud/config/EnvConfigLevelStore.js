Ext.define('AM.store.speedcloud.config.EnvConfigLevelStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.config.EnvConfigLevel'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.config.EnvConfigLevel'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/config/envconfiglevel'
                ...
                ,api:{read:"speedcloud/config/envconfiglevel/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
