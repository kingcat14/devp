Ext.define('AM.view.speedcloud.pipeline.task.PipelineTaskActionTypePropertyController', {
	extend: 'Ext.app.ViewController',
	requires: [

	]
	,alias: 'controller.speedcloud.pipeline.task.PipelineTaskActionTypePropertyController'
    ...
    ,onAddButtonClick: function() {
        ...
        var modelConfig = {}
        var record = Ext.create('AM.model.speedcloud.pipeline.task.PipelineTaskActionTypeProperty', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除操作类型属性定义成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onSimpleSearchButtonClick: function(button, e, options) {
        ...
        var taskTypeField = me.lookupReference("taskTypeField");
        searchWindow.down('#taskTypeField').setValue(taskTypeField.getValue());
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true
            ,url: "pipeline/task/pipelineTaskActionTypeProperty/export"
            ,method: "POST"
