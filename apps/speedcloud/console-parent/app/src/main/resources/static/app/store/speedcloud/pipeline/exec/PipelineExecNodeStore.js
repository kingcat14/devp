Ext.define('AM.store.speedcloud.pipeline.exec.PipelineExecNodeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.speedcloud.pipeline.exec.PipelineExecNode'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.speedcloud.pipeline.exec.PipelineExecNode'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'speedcloud/pipeline/exec/pipelineexecnode'
                ...
                ,api:{read:"speedcloud/pipeline/exec/pipelineexecnode/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
