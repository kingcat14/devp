...
public class DevpSysDpyResourcesTypeValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
	    if(obj instanceof DevpSysDpyResourcesTypeAddDto){
            this.validateAddDto((DevpSysDpyResourcesTypeAddDto)obj, errors);
        }
	}
     ...
     * @param errors
     */
		public void validateAddDto(DevpSysDpyResourcesTypeAddDto devpSysDpyResourcesType, Errors errors) {
