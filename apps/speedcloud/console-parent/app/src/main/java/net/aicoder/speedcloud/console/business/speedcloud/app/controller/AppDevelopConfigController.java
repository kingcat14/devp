...
public class AppDevelopConfigController {
	...
	@Autowired
	AppDevelopConfigValidator appDevelopConfigValidator;
	...
	public AppDevelopConfigVO add(@RequestBody AppDevelopConfigAddDto appDevelopConfigAddDto){
    	appDevelopConfigAddDto.setTid(saaSUtil.getAccount().getTenantId());
	...
	public void delete(@PathVariable String idArray){
		...
		for (String id : ids ){
			appDevelopConfigRibbonService.delete(Long.parseLong(id));
		}
	...
	@PutMapping(value="/{id}")
	public AppDevelopConfigVO update(@RequestBody AppDevelopConfigEditDto appDevelopConfigEditDto, @ApiParam(value = "要查询的应用开发配置id") @PathVariable Long id){
	...
	@GetMapping(value="/{id}")
	public AppDevelopConfigVO get(@ApiParam(value = "要查询的应用开发配置id") @PathVariable Long id) {
	...
	public PageContent<AppDevelopConfigVO> list(@RequestBody PageSearchRequest<AppDevelopConfigCondition> pageSearchRequest){
		...
		AppDevelopConfigCondition condition = pageSearchRequest.getSearchCondition();
		if(condition==null){
			condition = new AppDevelopConfigCondition();
