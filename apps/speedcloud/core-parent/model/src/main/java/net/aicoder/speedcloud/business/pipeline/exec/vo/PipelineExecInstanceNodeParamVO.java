...
public class PipelineExecInstanceNodeParamVO {
    ...
    private Long node;
    private PipelineExecInstanceNodeVO nodeVO;
    ...
    public PipelineExecInstanceNodeVO getNodeVO(){
        return nodeVO;
    }
    public void setNodeVO(PipelineExecInstanceNodeVO nodeVO) {
        this.nodeVO = nodeVO;
    }
