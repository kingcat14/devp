...
public class PipelineExecInstanceNodeParamsVO {
    ...
    private PipelineExecInstanceNodeVO taskTypeVO;
    ...
    public PipelineExecInstanceNodeVO getTaskTypeVO(){
        return taskTypeVO;
    }
    public void setTaskTypeVO(PipelineExecInstanceNodeVO taskTypeVO) {
