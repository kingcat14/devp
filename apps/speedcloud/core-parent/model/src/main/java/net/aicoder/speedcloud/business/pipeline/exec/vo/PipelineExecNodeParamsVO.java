...
public class PipelineExecNodeParamsVO {
    ...
    private PipelineExecNodeVO taskTypeVO;
    ...
    public PipelineExecNodeVO getTaskTypeVO(){
        return taskTypeVO;
    }
    public void setTaskTypeVO(PipelineExecNodeVO taskTypeVO) {
