 ...
 */
@Entity
@Table(appliesTo = "devp_sys_dpy_resource_ref", comment = "[方案资源间关系]")
//@DynamicUpdate
//@DynamicInsert
public class DevpSysDpyResourceRef extends BaseEntity<Long>{
    ...
    * [部署方案编号]
    */
    @Column(name = "scheme", nullable = false, updatable = true)
	private Long scheme;
