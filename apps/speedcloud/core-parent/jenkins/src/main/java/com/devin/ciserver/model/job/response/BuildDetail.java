...
public class BuildDetail {
    ...
    private List<StageConsoleOutput> pipelineConsoleOutputText;
    private long number;
    ...
    public BuildDetail(String displayName, String fullDisplayName, String id, String result, String consoleOutputText, String consoleOutputHtml, List<StageConsoleOutput> pipelineConsoleOutputText, long number, long duration, long timestamp) {
    ...
    public List<StageConsoleOutput> getPipelineConsoleOutputText() {
        return pipelineConsoleOutputText;
    }

    public void setPipelineConsoleOutputText(List<StageConsoleOutput> pipelineConsoleOutputText) {
        this.pipelineConsoleOutputText = pipelineConsoleOutputText;
    }
