...
public class ResourceTreeNode {
    ...
    public ResourceCategoryVO getCategoryVO() {
        return categoryVO;
    }
    public void setCategoryVO(ResourceCategoryVO categoryVO) {
    ...
    public ResourceTypeVO getTypeVO() {
        return typeVO;
    }
    public void setTypeVO(ResourceTypeVO typeVO) {
        this.typeVO = typeVO;
    }
