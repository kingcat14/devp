 ...
 * @author icode
 */
@Entity(name = "deployscheme_resource_relation_type")
@Table(appliesTo = "deployscheme_resource_relation_type", comment = "[资源关系类型]")
//@DynamicUpdate
//@DynamicInsert
public class ResourceRelationType extends BaseEntity<Long>{
