 ...
 * @author icode
 */
@ApiModel(value = "新增组件关联资源使用的DTO")
public class DevpSysCmpResAddDto {
    ...
    /**元素类型*/
	@ApiModelProperty(value = "元素类型", required = false, notes = "[元素类型]-SYS_CMP_RES // 部署组件关联资源")
    ...
    /**资源编号*/
	@ApiModelProperty(value = "资源编号", required = false, notes = "[资源编号]")
	private Long resRid;
