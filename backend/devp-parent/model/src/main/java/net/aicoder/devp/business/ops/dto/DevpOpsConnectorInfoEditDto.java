 ...
 * @author icode
 */
@ApiModel(value = "修改运维元素连接扩充信息使用的DTO")
public class DevpOpsConnectorInfoEditDto {
	...
	/**关联连接编号*/
	@ApiModelProperty(value = "关联连接编号", required = false, notes = "[关联连接编号]")
	private Long contRid;


	/**来源元素编号*/
	@ApiModelProperty(value = "来源元素编号", required = false, notes = "[来源元素编号]")
	private Long srcElmRid;


	/**来源元素实例编号*/
	@ApiModelProperty(value = "来源元素实例编号", required = false, notes = "[来源元素实例编号]-缺省值为0")
	private Long srcInstRid;


	/**目的元素编号*/
	@ApiModelProperty(value = "目的元素编号", required = false, notes = "[目的元素编号]")
	private Long destElmRid;


	/**目的元素实例编号*/
	@ApiModelProperty(value = "目的元素实例编号", required = false, notes = "[目的元素实例编号]-缺省值为0")
	...
	/**设值方式代码*/
	@ApiModelProperty(value = "设值方式代码", required = false, notes = "[设值方式代码]-S-仅对来源,D-仅对目标,Bi-双方,N-均无效")
	private String typeCode;


	/**设值方式名称*/
	@ApiModelProperty(value = "设值方式名称", required = false, notes = "[设值方式名称]-S-仅对来源,D-仅对目标,Bi-双方,N-均无效")
