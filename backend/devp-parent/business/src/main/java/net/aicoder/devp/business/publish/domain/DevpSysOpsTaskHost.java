...
public class DevpSysOpsTaskHost extends BaseEntity{
	...
	public static final String PROPERTY_ENV_RID = "envRid";
	public static final String PROPERTY_NEED_DPY = "needDpy";
    ...
    * [执行环境编号]
    */
    @Column(name = "env_rid", nullable = false, updatable = true)
	private Long envRid;
    ...
    * [是否部署]-0-不需部署；1-部署
    */
    @Column(name = "need_dpy", nullable = true, updatable = true)
