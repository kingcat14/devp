...
public class DevpOpsConnectorInfo extends BaseEntity{
	...
	public static final String PROPERTY_SRC_ELM_RID = "srcElmRid";
	public static final String PROPERTY_SRC_INST_RID = "srcInstRid";
	public static final String PROPERTY_DEST_ELM_RID = "destElmRid";
	public static final String PROPERTY_DEST_INST_RID = "destInstRid";
    ...
    * [关联连接编号]
    */
    @Column(name = "cont_rid", nullable = false, updatable = true)
    ...
    * [来源元素编号]
    */
    @Column(name = "src_elm_rid", nullable = false, updatable = true)
    ...
    * [来源元素实例编号]-缺省值为0
    */
    @Column(name = "src_inst_rid", nullable = false, updatable = true)
    ...
    * [目的元素编号]
    */
    @Column(name = "dest_elm_rid", nullable = false, updatable = true)
    ...
    * [目的元素实例编号]-缺省值为0
    */
    @Column(name = "dest_inst_rid", nullable = false, updatable = true)
    ...
    */
    ...
    /**
    * 设值方式代码
    * [设值方式代码]-S-仅对来源,D-仅对目标,Bi-双方,N-均无效
    */
    @Column(name = "type_code", nullable = true, updatable = true)
	@Size(max = 255, message = "设值方式代码超长，最多255个字符")
	private String typeCode;

    /**
    * 设值方式名称
    * [设值方式名称]-S-仅对来源,D-仅对目标,Bi-双方,N-均无效
    */
    @Column(name = "type_name", nullable = true, updatable = true)
	@Size(max = 255, message = "设值方式名称超长，最多255个字符")
