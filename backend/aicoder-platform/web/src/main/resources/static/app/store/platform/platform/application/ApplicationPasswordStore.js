Ext.define('AM.store.platform.platform.application.ApplicationPasswordStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.platform.platform.application.ApplicationPassword'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.platform.platform.application.ApplicationPassword'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"platform/application/applicationPassword/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
