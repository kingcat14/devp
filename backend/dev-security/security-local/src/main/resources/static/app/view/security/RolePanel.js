...
Ext.define('AM.view.security.RolePanel', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.securityRolePanel',
	requires: [
		'AM.view.security.RoleResourceTreeWindow'
	],
	height: 250,
	width: 400,
	layout: {
							...
							items: [
								{
									handler: function(view, rowIndex, colIndex, item, e, record, row) {
										...
										if(!me.window){
											me.window = Ext.widget('securityRoleResourceTreeWindow');
										}
	...
	onAddButtonClick: function(button, e, options) {
		...
		var record = Ext.create('AM.model.security.Role', {});
	...
	,showDetailWindow: function(model, options) {
		...
		if(!detailWindow){
			...
			detailWindow = Ext.create('AM.view.security.RoleWindow', {store:me.down('gridpanel').getStore()});
