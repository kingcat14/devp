...
import com.yunkang.saas.security.local.business.domain.*;
...
import com.yunkang.saas.security.model.vo.UpdatePasswordRequest;
import com.yunkang.saas.security.model.vo.UpdatePasswordResponse;
...
public class AccountManageService {
	...
	public List<Resource> findResourceTree(String accountName){
		...
		for(AccountRoleRelation roleMapping : roleMappings){
			...
			//得到所有额资源ID
			for(com.yunkang.saas.security.local.business.domain.RoleResourceRelation RoleResourceRelation:RoleResourceRelationList){
