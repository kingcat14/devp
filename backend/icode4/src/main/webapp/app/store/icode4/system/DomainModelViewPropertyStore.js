Ext.define('AM.store.icode4.system.DomainModelViewPropertyStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.icode4.system.DomainModelViewProperty'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.system.DomainModelViewProperty'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"system/domainModelViewProperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
