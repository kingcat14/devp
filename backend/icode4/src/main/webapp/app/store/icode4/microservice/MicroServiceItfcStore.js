Ext.define('AM.store.icode4.microservice.MicroServiceItfcStore', {
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.microservice.MicroServiceItfc'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"microservice/microServiceItfc/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
