Ext.define('AM.store.icode4.microservice.MicroServiceItfcParametersStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.icode4.microservice.MicroServiceItfcParameters'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.microservice.MicroServiceItfcParameters'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"microservice/microServiceItfcParameters/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
