Ext.define('AM.store.icode4.database.DatabaseTableInfoStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.icode4.database.DatabaseTableInfo'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.database.DatabaseTableInfo'
            ,pageSize: 1000
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"database/databaseTableInfo/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
