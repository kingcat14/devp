Ext.define('AM.store.icode4.database.DatabaseProjectStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.icode4.database.DatabaseProject'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.database.DatabaseProject'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"database/databaseProject/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
