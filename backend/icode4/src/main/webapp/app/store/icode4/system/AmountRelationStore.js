Ext.define('AM.store.icode4.system.AmountRelationStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.icode4.system.AmountRelation'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.system.AmountRelation'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"system/amountRelation/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
