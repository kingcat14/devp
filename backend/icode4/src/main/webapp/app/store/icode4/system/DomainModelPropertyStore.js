Ext.define('AM.store.icode4.system.DomainModelPropertyStore', {
    extend: 'Ext.data.Store'
    ,xtype: 'icode4.system.DomainModelPropertyStore'
    ,alias: 'store.systemDomainModelPropertyStore'
    ,requires: [
    ...
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.system.DomainModelProperty'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"system/domainModelProperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
