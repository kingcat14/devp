Ext.define('AM.store.icode4.microservice.TransModelPropertyStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.icode4.microservice.TransModelProperty'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.microservice.TransModelProperty'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"microservice/transModelProperty/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
