Ext.define('AM.store.icode4.microservice.TransModelItfcMappingStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.icode4.microservice.TransModelItfcMapping'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.microservice.TransModelItfcMapping'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
                ...
                ,api:{read:"microservice/transModelItfcMapping/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
