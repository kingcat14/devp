Ext.define('AM.store.icode4.microservice.TransModelStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.icode4.microservice.TransModel'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.icode4.microservice.TransModel'
            ,pageSize: 10
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"microservice/transModel/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
