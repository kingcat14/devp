Ext.define('AM.view.icode4.system.ModuleSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'icode4.system.ModuleSearchWindow'
    ,autoScroll: true
    ,height: 250
    ,width: 400
    ,layout: {
    ...
    ,onSearchButtonClick: function (button, e, options) {
        ...
        var parentModuleField = me.down("#parentModuleField");
        var systemField = me.down("#systemField");

        var searchCondition = {
            name:Ext.isEmpty(nameField.getValue())?null:nameField.getValue()
            ,code:Ext.isEmpty(codeField.getValue())?null:codeField.getValue()
            ,parentModule:Ext.isEmpty(parentModuleField.getValue())?null:parentModuleField.getValue()
