Ext.define('AM.view.icode4.tplfileboard.TplFileBoardController', {

	extend: 'Ext.app.ViewController'
	,requires: [

	]
	,alias: 'controller.icode4.tplfileboard.TplFileBoardController'
	...
	,treeItemClick:function(treeView, record, item, index, e, options) {
		...
		if("TPL_SET"==type) {
			...
			AM.model.icode4.tplfile.TplSet.load(nodeId, {
