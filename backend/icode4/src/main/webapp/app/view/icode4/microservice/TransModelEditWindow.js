Ext.define('AM.view.icode4.microservice.TransModelEditWindow', {
    ...
    onSaveButtonClick: function (button, e, options) {
        ...
        record.save({
            success: function (newRecord) {
                Ext.MsgUtil.show('操作成功', '保存传输对象成功!');
                me.down('form').getForm().loadRecord(newRecord);
                me.store.load({
                    callback: function (records, operation, success) {
                        if (success) {
                            Ext.MsgUtil.show('操作成功', '同步传输对象列表成功');
                        }
                    }
                });
            }
    ...
    setModel: function (model) {
        ...
        this.setTitle("修改传输对象信息");
        if(model.phantom){
            this.setTitle("新增传输对象信息");
        }
