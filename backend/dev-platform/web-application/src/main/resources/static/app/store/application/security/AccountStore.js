Ext.define('AM.store.application.security.AccountStore', {
    extend: 'Ext.data.Store',

    requires: [
        'AM.model.application.security.Account'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false,
            model: 'AM.model.application.security.Account',
            pageSize: 10,
            proxy: {
                type: 'rest',
                ...
                api:{read:"application/security/account/list"},
                paramsAsJson:true,
                listeners: {
                    exception: {
