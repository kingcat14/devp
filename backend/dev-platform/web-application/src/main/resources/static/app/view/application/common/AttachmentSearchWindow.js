Ext.define('AM.view.application.common.AttachmentSearchWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'application.common.AttachmentSearchWindow'
    ,alias: 'widget.applicationcommonAttachmentSearchWindow'
    ,autoScroll: true
    ,height: 250
    ,width: 400
    ,layout: {
