Ext.define('AM.store.application.security.RoleResourceRelationStore', {
    extend: 'Ext.data.Store',

    requires: [
        'AM.model.application.security.RoleResourceRelation'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false,
            model: 'AM.model.application.security.RoleResourceRelation',
            pageSize: 10,
            proxy: {
                type: 'rest',
                ...
                api:{read:"application/security/roleResourceRelation/list"},
                paramsAsJson:true,
                listeners: {
                    exception: {
