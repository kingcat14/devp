Ext.define('AM.store.platform.security.RoleResourceRelationTreeStore', {
    extend: 'Ext.data.TreeStore',

    requires: [
        'AM.model.platform.security.RoleResourceRelationTreeNode'
    ],
	model: 'AM.model.platform.security.RoleResourceRelationTreeNode',
	autoLoad: false,
	nodeParam:'id',
	root: {
		expanded: false,
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            proxy: {
                ...
                api:{read:"platform/security/roleResourceRelation?method=getChildNodes"},
	            reader: {
		            type: 'json'
		            //,root: 'content'
	            },
