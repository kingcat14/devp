Ext.define('AM.store.platform.security.AccountRoleRelationStore', {
    extend: 'Ext.data.Store',

    requires: [
        'AM.model.platform.security.AccountRoleRelation'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false,
            model: 'AM.model.platform.security.AccountRoleRelation',
            pageSize: 10,
            proxy: {
                type: 'rest',
                ...
                api:{read:"platform/security/accountRoleRelation/list"},
                paramsAsJson:true,
                listeners: {
                    exception: {
