Ext.define('AM.store.platform.security.RoleResourceRelationStore', {
    extend: 'Ext.data.Store',

    requires: [
        'AM.model.platform.security.RoleResourceRelation'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false,
            model: 'AM.model.platform.security.RoleResourceRelation',
            pageSize: 10,
            proxy: {
                type: 'rest',
                ...
                api:{read:"platform/security/roleResourceRelation/list"},
                paramsAsJson:true,
                listeners: {
                    exception: {
