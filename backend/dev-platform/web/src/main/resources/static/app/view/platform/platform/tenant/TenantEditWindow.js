Ext.define('AM.view.platform.platform.tenant.TenantEditWindow', {
    extend: 'Ext.window.Window'
    ,xtype: 'platform.platform.tenant.TenantEditWindow'
    ,requires:[
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        ,{
                            xtype: 'combobox',
                            store: Ext.create("AM.store.platform.platform.tenant.TenantTypeStore", {autoLoad:true, asynchronousLoad:false, pageSize:1000}),
                            typeAhead:false,
                            editable:false,
                            displayField:'name',
                            valueField:'id',
