Ext.define('AM.store.platform.platform.tenant.TenantTypeStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.platform.platform.tenant.TenantType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.platform.platform.tenant.TenantType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"platform/tenant/tenantType/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
