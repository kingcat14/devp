Ext.define('AM.store.platform.platform.application.ConfigAppCategoryStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.platform.platform.application.ConfigAppCategory'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.platform.platform.application.ConfigAppCategory'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'platform/application/configAppCategory'
                ...
                ,api:{read:"platform/application/configAppCategory/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
