Ext.define('AM.store.platform.security.RoleStore', {
    extend: 'Ext.data.Store',

    requires: [
        'AM.model.platform.security.Role'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false,
            model: 'AM.model.platform.security.Role',
            pageSize: 10,
            proxy: {
                type: 'rest',
                ...
                api:{read:"platform/security/role/list"},
                paramsAsJson:true,
                listeners: {
                    exception: {
