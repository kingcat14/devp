Ext.define('AM.store.application.common.SimpleConfigStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.application.common.SimpleConfig'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.application.common.SimpleConfig'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"common/simpleConfig/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
