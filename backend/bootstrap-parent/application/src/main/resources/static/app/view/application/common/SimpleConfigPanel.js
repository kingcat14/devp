Ext.define('AM.view.application.common.SimpleConfigPanel', {
    ...
    ,requires: [
        ...
        ,'AM.view.application.common.SimpleConfigEditWindow'
        ,'AM.view.application.common.SimpleConfigSearchWindow'
        ,'AM.view.application.common.SimpleConfigDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'application.common.SimpleConfigAddWindow',reference:'simpleConfigAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'application.common.SimpleConfigEditWindow',reference:'simpleConfigEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'application.common.SimpleConfigSearchWindow',reference:'simpleConfigSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'application.common.SimpleConfigDetailWindow',reference:'simpleConfigDetailWindow'})
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.application.common.SimpleConfig', modelConfig);
