...
public class PersonalAspect {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PersonalAspect.class);


    @Autowired(required = false)
    private SaaSUtil saaSUtil;

    @Pointcut("@annotation(com.yunkang.saas.bootstrap.application.business.annotation.PersonalAnnotation)")
