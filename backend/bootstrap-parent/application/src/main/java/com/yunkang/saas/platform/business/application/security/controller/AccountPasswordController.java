...
import com.yunkang.saas.platform.business.application.security.valid.AccountPasswordValidator;
 ...
 * @author icode
 */
@RestController("applicationAccountPasswordController")
@RequestMapping(value = "/application/security/accountPassword")
