...
import com.yunkang.saas.bootstrap.platform.config.PlatformConfig;
import com.yunkang.saas.bootstrap.security.local.business.authorize.service.SecurityUserService;
...
//	private SecurityUserService securityUserService;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		String[] antMatchers = {"/security/login/authenticate", "/login.html", "/ext_/**"
				...
				,"/**/*.css"
				,"/ext_*/**/*","/current/app","/swagger-resources"
		};
