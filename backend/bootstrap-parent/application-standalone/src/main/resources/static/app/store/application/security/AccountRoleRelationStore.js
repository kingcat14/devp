Ext.define('AM.store.application.security.AccountRoleRelationStore', {
    extend: 'Ext.data.Store',

    requires: [
        'AM.model.application.security.AccountRoleRelation'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false,
            model: 'AM.model.application.security.AccountRoleRelation',
            pageSize: 10,
            proxy: {
                type: 'rest',
                ...
                api:{read:"application/security/accountRoleRelation/list"},
                paramsAsJson:true,
                listeners: {
                    exception: {
