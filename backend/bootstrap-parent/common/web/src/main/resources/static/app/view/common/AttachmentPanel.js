Ext.define('AM.view.common.AttachmentPanel', {
    extend: 'Ext.grid.Panel'
    ,xtype: 'common.AttachmentPanel'
    ,title: 'Attachment'
    ,requires: [
        'AM.view.common.AttachmentController'
        ,'AM.view.common.AttachmentAddWindow'
        ,'AM.view.common.AttachmentEditWindow'
        ,'AM.view.common.AttachmentSearchWindow'
        ,'AM.view.common.AttachmentDetailWindow'
    ]
    ...
    ,initComponent: function() {
        ...
        me.add({xtype:'common.AttachmentAddWindow',reference:'attachmentAddWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'common.AttachmentEditWindow',reference:'attachmentEditWindow',listeners:{saved:'reloadStore'}})
        me.add({xtype:'common.AttachmentSearchWindow',reference:'attachmentSearchWindow',listeners:{saved:'doSearch'}})
        me.add({xtype:'common.AttachmentDetailWindow',reference:'attachmentDetailWindow'})
    ...
    ,onSimpleSearchButtonClick: function(button, e, options) {
        ...
        var searchCondition = {type:simpleSearchField.getValue()}
	...
	,onAddButtonClick: function(button, e, options) {
        ...
        var record = Ext.create('AM.model.common.Attachment', modelConfig);

        options.src = button;
        var addWindow = this.showAddWindow(record, button);
        addWindow.setTitle('添加新Attachment');
    }
    ,onEditButtonClick: function(button, e, options) {
        ...
        detailWindow.setTitle('修改Attachment信息');
    }
                ...
                store.loadPage(targetPage,{
                    ...
                    callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.show('操作成功','删除Attachment成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onItemDblClick: function(tablepanel, record, item, index, e, options) {
        ...
        editWindow.setTitle('修改Attachment信息');
    }
    ,showAddWindow: function(model, targetComponent) {
        var me = this;
        var addWindow = me.lookupReference('attachmentAddWindow');
    ...
    ,showEditWindow: function(model, targetComponent) {
        var me = this;
        var editWindow = me.lookupReference('attachmentEditWindow');
    ...
    ,showDetailWindow: function(model, targetComponent) {
        var me = this;
        var detailWindow = me.lookupReference('attachmentDetailWindow');
    ...
    ,showSearchWindow: function(button, e, options) {
        ...
        var searchWindow = me.lookupReference('attachmentSearchWindow');
