...
import com.yunkang.saas.application.business.application.service.AppService;
import com.yunkang.saas.application.business.application.valid.AppValidator;
...
public class AppController {
	...
	private AppVO initViewProperty(App app){
	    ...
	    //初始化其他对象
	    initAppCategoryPropertyGroup(vo, app);
        return vo;
	}


	private void initAppCategoryPropertyGroup(AppVO appVO, App app){
	
		AppCategory appCategory = appCategoryService.find(app.getAppCategoryId());
		if(appCategory == null){
			return;
		}
        appVO.setAppCategoryCode(appCategory.getCode());
