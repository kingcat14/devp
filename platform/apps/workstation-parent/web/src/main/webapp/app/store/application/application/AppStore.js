Ext.define('AM.store.application.application.AppStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.application.application.App'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.application.application.App'
            ,pageSize: 10
            ,limitParam:'pageSize'
            ,proxy: {
                type: 'rest'
