Ext.define('AM.view.monitor.notification.NotificationTypeController', {
	extend: 'Ext.app.ViewController'
	,requires: [

	]
	,alias: 'controller.monitor.notification.NotificationTypeController'

	,onAddButtonClick: function() {

        var modelConfig = {}
        var record = Ext.create('AM.model.monitor.notification.NotificationType', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    ,callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.notification('操作成功','删除通知方式成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true 
            ,url: "monitor/notification/notificationtype/export"
            ,method: "POST"
