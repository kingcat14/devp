Ext.define('AM.view.monitor.app.ApplicationTypeController', {
	extend: 'Ext.app.ViewController'
	,requires: [

	]
	,alias: 'controller.monitor.app.ApplicationTypeController'

	,onAddButtonClick: function() {

        var modelConfig = {}
        var record = Ext.create('AM.model.monitor.app.ApplicationType', modelConfig);
                ...
                store.loadPage(targetPage,{
                    ...
                    ,callback: function(records, operation, success) {
                        if(!success)
                        	...
                        	Ext.MsgUtil.notification('操作成功','删除程序类型成功!');
                    }
                });
            }
            ,scope:me.getStore()
    ...
    ,onExportButtonClick: function(button, e, options) {
        ...
        Ext.Ajax.request({
            disableCaching: true 
            ,url: "monitor/app/applicationtype/export"
            ,method: "POST"
