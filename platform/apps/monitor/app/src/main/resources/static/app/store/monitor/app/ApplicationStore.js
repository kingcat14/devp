Ext.define('AM.store.monitor.app.ApplicationStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.monitor.app.ApplicationStore'
    ,requires: [
        'AM.model.monitor.app.Application'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.monitor.app.Application'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"monitor/app/application/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
