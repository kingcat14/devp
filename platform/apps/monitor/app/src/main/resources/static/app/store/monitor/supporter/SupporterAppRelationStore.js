Ext.define('AM.store.monitor.supporter.SupporterAppRelationStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.monitor.supporter.SupporterAppRelationStore'
    ,requires: [
        'AM.model.monitor.supporter.SupporterAppRelation'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.monitor.supporter.SupporterAppRelation'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'monitor/supporter/supporterapprelation'
                ...
                ,api:{read:"monitor/supporter/supporterapprelation/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
