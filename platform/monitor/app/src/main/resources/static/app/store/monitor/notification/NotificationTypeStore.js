Ext.define('AM.store.monitor.notification.NotificationTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.monitor.notification.NotificationTypeStore'
    ,requires: [
        'AM.model.monitor.notification.NotificationType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.monitor.notification.NotificationType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"monitor/notification/notificationtype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
