Ext.define('AM.store.monitor.alarm.AlarmTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.monitor.alarm.AlarmTypeStore'
    ,requires: [
        'AM.model.monitor.alarm.AlarmType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.monitor.alarm.AlarmType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"monitor/alarm/alarmtype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
