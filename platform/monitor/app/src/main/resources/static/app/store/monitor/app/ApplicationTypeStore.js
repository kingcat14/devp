Ext.define('AM.store.monitor.app.ApplicationTypeStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.monitor.app.ApplicationTypeStore'
    ,requires: [
        'AM.model.monitor.app.ApplicationType'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.monitor.app.ApplicationType'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ,limitParam:'limit'
                ,url: 'monitor/app/applicationtype'
                ...
                ,api:{read:"monitor/app/applicationtype/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
