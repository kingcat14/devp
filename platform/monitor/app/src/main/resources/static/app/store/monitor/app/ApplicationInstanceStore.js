Ext.define('AM.store.monitor.app.ApplicationInstanceStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.monitor.app.ApplicationInstanceStore'
    ,requires: [
        'AM.model.monitor.app.ApplicationInstance'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.monitor.app.ApplicationInstance'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"monitor/app/applicationinstance/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
