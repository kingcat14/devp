Ext.define('AM.store.monitor.alarm.AlarmStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.monitor.alarm.AlarmStore'
    ,requires: [
        'AM.model.monitor.alarm.Alarm'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.monitor.alarm.Alarm'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"monitor/alarm/alarm/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
