Ext.define('AM.store.monitor.app.UnknownAppStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.monitor.app.UnknownAppStore'
    ,requires: [
        'AM.model.monitor.app.UnknownApp'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.monitor.app.UnknownApp'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"monitor/app/unknownapp/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
