Ext.define('AM.store.monitor.supporter.SupporterStore', {
    extend: 'Ext.data.Store'
    , alias: 'store.monitor.supporter.SupporterStore'
    ,requires: [
        'AM.model.monitor.supporter.Supporter'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.monitor.supporter.Supporter'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"monitor/supporter/supporter/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
