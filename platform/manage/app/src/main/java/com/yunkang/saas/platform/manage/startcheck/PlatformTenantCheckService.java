...
@Component
@Order(value=1)
public class PlatformTenantCheckService implements CommandLineRunner {

	private static final Logger LOGGER = LoggerFactory.getLogger(PlatformTenantCheckService.class);
