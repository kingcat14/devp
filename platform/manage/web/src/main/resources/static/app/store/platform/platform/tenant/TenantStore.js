Ext.define('AM.store.platform.platform.tenant.TenantStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.platform.platform.tenant.Tenant'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.platform.platform.tenant.Tenant'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"platform/tenant/tenant/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
