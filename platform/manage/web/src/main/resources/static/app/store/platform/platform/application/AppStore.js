Ext.define('AM.store.platform.platform.application.AppStore', {
    extend: 'Ext.data.Store'
    ,requires: [
        'AM.model.platform.platform.application.App'
    ]
    ,constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false
            ,model: 'AM.model.platform.platform.application.App'
            ,pageSize: 25
            ,proxy: {
                type: 'rest'
                ,pageParam:'page'
                ...
                ,api:{read:"platform/application/app/list"}
                ,paramsAsJson:true
                ,listeners: {
                    exception: {
